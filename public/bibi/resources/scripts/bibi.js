  ...
  2: function (e, t, n) {
    (function (t) {
      ...
      !(function (i) {
        e.exports
          ? (e.exports = i)
          : ((void 0 !== t ? t : void 0 !== n ? n : self).sML = i);
      })(
        (function () {
          "use strict";
          var e,
          ...
          return (
            (g.OperatingSystem =
              ((e = {}),
              /Mac OS X/.test(h)
                ? /\(iP(hone|ad|od touch);/.test(h)
                  ? (e.iOS = b("CPU (iPhone )?OS", "$2"))
                  : void 0 !== document.ontouchend
                  ? (e.iOS = e.iPadOS = b())
                  : /Mac OS X 10[\._]\d/.test(h) && (e.macOS = b("Mac OS X "))
                : /Windows( NT)? \d/.test(h)
                ? (e.Windows =
                    6 != (t = b("Windows( NT)?", "$2"))[0]
                      ? t
                      : t[1] >= 3
                      ? [8, 1]
                      : t[1] >= 2
            ...
            (g.UserAgent =
              ...
              / Gecko\/\d/.test(h)
                ? ((n.Gecko = b("rv")),
                  / Waterfox\/\d/.test(h)
                    ? (n.Waterfox = b("Waterfox"))
                    : / Firefox\/\d/.test(h) && (n.Firefox = b("Firefox")))
                : / Edge\/\d/.test(h)
                ? (n.EdgeHTML = n.Edge = b("Edge"))
                : / Chrom(ium|e)\/\d/.test(h)
                ? ((n.Blink = n.Chromium = (function (e) {
                ...
                : / AppleWebKit\/\d/.test(h)
                ? ((n.WebKit = b("AppleWebKit")),
                  / CriOS \d/.test(h)
                    ? (n.Chrome = b("CriOS"))
                    : / FxiOS \d/.test(h)
                    ? (n.Firefox = b("FxiOS"))
                    : / EdgiOS\/\d/.test(h)
                    ? (n.Edge = b("EdgiOS"))
                    : / Version\/\d/.test(h) && (n.Safari = b("Version")))
                : / Trident\/\d/.test(h) &&
                  ((n.Trident = b("Trident")),
              ...
              n)),
            (g.Environments = [g.OperatingSystem, g.UserAgent].reduce(function (
              e,
              t
            ) {
            ...
            (g.edit = function (e) {
              ...
              if (e.tagName)
                for (var n = 0; n < t; n++) {
                  ...
                  if (i.on) for (var a in i.on) e.addEventListener(a, i.on[a]);
            ...
            (g.hatch = function (e) {
              var t = g.create("div", { innerHTML: e }),
            ...
            (g.apply = function () {
              ...
              if (e.From && e.To)
                if (t)
                  for (var n in e.From)
                    "function" != typeof e.To[n] &&
                      "function" != typeof e.From[n] &&
                      (e.To[n] = e.From[n]);
                else for (var i in e.From) e.To[i] = e.From[i];
              return e.To;
            }),
            (g.applyLtR = function (e, t, n) {
              return g.apply({ From: e, To: t }, n);
            }),
            (g.applyRtL = function (e, t, n) {
              return g.apply({ From: t, To: e }, n);
            }),
            ...
            (g.CSS = {
              _get_sMLStyle_sheet: function () {
                ...
                return (
                  e.sMLStyle ||
                    ((e.sMLStyle = e.createElement("style")),
              ...
              appendRule: function (e, t) {
                ...
                return i.insertRule(
                  (e instanceof Array ? e.join(", ") : e) +
                    " { " +
                    (t instanceof Array ? t.join(" ") : t) +
                    " }",
                  i.cssRules.length
                );
              },
              ...
              _add_sMLTransitionEndListener: function (e, t) {
                var n = this;
                e._sMLTransitionEndListener &&
                  this._remove_sMLTransitionEndListener(e),
                  (e._sMLTransitionEndListener = function (i) {
                    return (
                      t.call(e, i) && n._remove_sMLTransitionEndListener(e)
                    );
                  }),
                  e.addEventListener(
                    "transitionend",
              ...
              setTransition: function (e) {
                ...
                if (e instanceof Array) {
                  for (var o = [], a = e.length, s = 0; s < a; s++) {
                    var c;
                    o.push(
                      (c = g.CSS).setTransition.apply(c, [e[s]].concat(i))
                    );
                  }
            ...
            (g.Coords = {
              ...
              getOffsetSize: function (e) {
                return (
                  ...
                  e == document
                    ? this.getScrollSize(document.documentElement)
                    : this.getWidthHeight(e.offsetWidth, e.offsetHeight)
                );
              },
              getClientSize: function (e) {
                return (
                  ...
                  e == document
                    ? this.getScrollSize(document.documentElement)
                    : this.getWidthHeight(e.clientWidth, e.clientHeight)
                );
              },
              ...
              getElementCoord: function (e) {
                for (var t = e.offsetLeft, n = e.offsetTop; e.offsetParent; )
                  (t += (e = e.offsetParent).offsetLeft), (n += e.offsetTop);
                return this.getXY(t, n);
              },
              getScrollCoord: function (e) {
                return e && e != window
                  ? this.getXY(e.scrollLeft, e.scrollTop)
                  : this.getXY(
                      window.scrollX ||
                        window.pageXOffset ||
              ...
              getCoord: function (e) {
                ...
                return (
                  e.tagName
                    ? ((t = this.getElementCoord(e)),
                      (n = this.getOffsetSize(e)))
                    : e == window
                    ? ((t = this.getScrollCoord()),
                      (n = this.getOffsetSize(document.documentElement)))
                    : e == document
                    ? ((t = { X: 0, Y: 0 }),
                      (n = this.getScrollSize(document.documentElement)))
                    : e == screen &&
                      ((t = { X: 0, Y: 0 }), (n = this.getScreenSize())),
                  {
                    X: t.X,
                    Y: t.Y,
                    Top: t.Y,
                ...
                (this.dispatch = function (e, t) {
                  ...
                  return (
                    ...
                    a instanceof Array
                      ...
                      : !("object" != r(a) || !i.test(e)) &&
                        (a[n] &&
                          a[n][e] instanceof Array &&
                          a[n][e].forEach(function (e) {
                            return "function" == typeof e && e.call(a, t);
                          }),
                        a.dispatchEvent(new CustomEvent(e, { detail: t })),
                        t)
                  );
                }),
                this
            ...
            (g.Scroller = {
              scrollTo: function (e) {
                var t,
                  ...
                  i =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ...
                      : {},
                  o =
                    e.Frame && e.Frame instanceof HTMLElement
                      ? e.Frame
                      : window,
                  a = {};
                if (
                  (o.sMLScrollerSetting
                    ? (a = o.sMLScrollerSetting).cancel()
                    : (((a = o.sMLScrollerSetting = { Frame: o }).scrollTo =
                        a.Frame === window
                          ? function (e, t) {
                      ...
                      (a.allowUserScrolling = function () {
                        return [
                          ...
                          return a.Frame.removeEventListener(
                            e,
                            g.preventDefault
                          );
                        });
                  ...
                  e instanceof HTMLElement
                    ? (a.Target = g.Coord.getElementCoord(e))
                    : (a.Target =
                        "number" == typeof e
                          ? { Y: e }
                          : e
                  ...
                  return a.scrollTo(a.Target.X, a.Target.Y), Promise.resolve();
                switch (r(i.ease)) {
                  case "function":
                    a.ease = i.ease;
                    break;
                  case "string":
                    a.ease = g.Easing[i.ease]
                      ? g.Easing[i.ease]
                      : g.Easing.linear;
                    break;
                  default:
                ...
                return (
                  (a.ForceScroll = i.ForceScroll),
                  a.ForceScroll
                    ? (a.preventUserScrolling(),
                      (t = function () {
              ...
              scrollInProgress: function () {
                ...
                t.scrollTo(
                  Math.round(t.Start.X + (t.Target.X - t.Start.X) * i),
                  Math.round(t.Start.Y + (t.Target.Y - t.Start.Y) * i)
                ),
            ...
            (g.Easing =
              ...
              }),
              {
                ...
                easeInOutBack: function (e) {
                  return (
                    ((e *= 2) < 1
                      ? 3.5949095 * o(e, 3) - 2.5949095 * o(e, 2)
                      : 2 + 3.5949095 * o(e - 2, 3) + 2.5949095 * o(e - 2, 2)) /
                    2
                  );
                },
                ...
                easeInOutElastic: function (e) {
                  return e
                    ? 1 == e
                      ? 1
                      : ((e *= 2) < 1
                          ? -1 * o(2, 10 * --e) * s((10 * e - 1.125) * d)
                          : 2 + o(2, -10 * --e) * s((10 * e - 1.125) * d)) / 2
                    : 0;
                },
            ...
            (g.Cookies = {
              ...
              write: function (e, t, n) {
                var i = new Date();
                return (
                  !(!e || "string" != typeof e || "string" != typeof t) &&
                  ("object" != r(n) && (n = {}),
                  (e = encodeURIComponent(e)),
                  ...
                  (n.Expires =
                    "number" == typeof n.Expires ? n.Expires : 864e5),
                  (document.cookie = [
                    e + "=" + t,
                    "path=" + n.Path,
                    "expires=" +
                      i.toGMTString(i.setTime(i.getTime() + n.Expires)),
                  ].join("; ")),
                  document.cookie)
                );
              },
            ...
            (g.Ranges = {
              ...
              getRange: function () {
                var e =
                  "object" == r(arguments[0])
                    ? arguments[0]
                    : this._searchSidesOfText.apply(this, arguments);
                if (!e) return null;
                var t = e.Start.Node.ownerDocument.createRange();
                return (
                  t.setStart(
                    e.Start.Node,
                    "number" == typeof e.Start.Index
                      ? e.Start.Index
                      : e.Start.Node.textContent.indexOf(e.Start.Text)
                  ),
                  t.setEnd(
                    e.End.Node,
                    "number" == typeof e.End.Index
                      ? e.End.Index
                      : e.End.Node.textContent.indexOf(e.End.Text) +
                          e.End.Text.length
                  ),
                  t
                );
              ...
              _searchSidesOfText: function (e, t) {
                if (
                  ...
                  "string" != typeof e ||
                    !e ||
                    this._flat(t.textContent).indexOf(e) < 0)
                )
                  return null;
                if (3 == t.nodeType)
                  return {
                ...
                for (
                  ...
                  s && this._flat(s).indexOf(e) >= 0;

                )
                  o++, (s = this._distill(n, o + 1, a));
                ...
                for (
                  ...
                  this._flat(s) &&
                  !new RegExp("^" + this._escape(this._flat(s))).test(e);

                )
                  u++, (s = this._distill(l.textContent, u, p));
                ...
                for (
                  ...
                  h--, (s = this._distill(f.textContent, 0, h));
              ...
              polyfill: function () {
                ...
                if (void 0 === t.fullscreenEnabled) {
                  if ("function" != typeof Promise)
                    throw new Error(
                      "sML.Fullscreen.polyfill requires Promise."
                    );
                  var i = t.webkitFullscreenEnabled
                    ? "webkit"
                    : t.msFullscreenEnabled
                    ? "ms"
                    : "";
                  switch (i) {
                    case "webkit":
                    ...
                    case "ms":
                      t.onmsfullscreenchange = function () {
                        return t.dispatchEvent(
                          (e = t.createEvent("Event")).initEvent(
                            "fullscreenchange",
                            !0,
                            !1
                          ) || e
    ...
    function c(e, t) {
      for (var n = {}, i = [], r = 0; r < e.length; r++) {
        ...
        -1 !== d
          ...
          : a.push({ identifier: u, updater: b(p, t), references: 1 }),
          i.push(u);
      }
      return i;
    }
  ...
  47: function (e, t, n) {
    ...
    (function (e) {
      ...
      boolean: function (e, t, n) {
        return "boolean" == typeof t
          ...
          : "true" === t ||
              "1" === t ||
              1 === t ||
              ("false" !== t && "0" !== t && 0 !== t && !n && void 0);
      },
      "yes-no": function (e, t, n) {
        return /^(yes|no|mobile|desktop)$/.test(t)
          ? t
          : "true" === t || "1" === t || 1 === t
          ? "yes"
          : "false" === t || "0" === t || 0 === t || n
      ...
      string: function (e, t, n) {
        if ("string" == typeof t) {
          switch (e) {
            ...
            case "p":
              return /^([a-z]+|[1-9]\d*((\.[1-9]\d*)*|-[a-z]+))$/.test(t)
                ? t
                : void 0;
      ...
      number: function (e, t, n) {
        return "number" == typeof (t *= 1) && isFinite(t) && t >= 0
          ? t
          : n
          ? 0
          : void 0;
          ...
          n.forEach(function (n) {
            var r = function (r) {
              n[r].forEach(function (n) {
                ...
                i
                  ? ((e[n] = x.verifySettingValue[r](n, e[n])),
                    (void 0 === o && void 0 !== e[n]) ||
                      (e[n] = x.verifySettingValue[r](n, t[n], !0)))
                  : t.hasOwnProperty(n) && void 0 !== o && (e[n] = o);
              });
            };
            for (var o in n) r(o);
          }),
      ...
      (x.initialize = function () {
        ...
        if (
          ...
          (e = U.HTML.classList).add.apply(
            e,
            T(sML.Environments).concat(["Bibi", "welcome"])
          ),
          (U.TouchOS = !(!sML.OS.iOS && !sML.OS.Android)) &&
            (U.HTML.classList.add("touch"),
            sML.OS.iOS &&
              (U.Head.appendChild(
                sML.create("meta", {
          ...
          U.HTML.classList.add(
            "default-lang-" +
              (U.Language = (function (e) {
                Array.isArray(navigator.languages) &&
                  (e = e.concat(navigator.languages)),
                  navigator.language &&
                    navigator.language != e[0] &&
                    e.unshift(navigator.language);
          ...
          (U.Embedded = (function () {
            if (window.parent == window)
              return U.HTML.classList.add("window-direct"), 0;
          ...
          (U.ParentBibi =
            (1 === U.Embedded &&
              "number" == typeof F["parent-bibi-index"] &&
              window.parent["bibi:jo"].Bibis[F["parent-bibi-index"]]) ||
            null),
          ...
          (U.FullscreenTarget =
            (t =
              (U.Embedded
                ? U.ParentBibi
                  ? (sML.Fullscreen.polyfill(window.parent), U.ParentBibi.Frame)
                  : void 0
                : (sML.Fullscreen.polyfill(window), U.HTML)) || null) &&
            t.ownerDocument.fullscreenEnabled
              ? (U.HTML.classList.add("fullscreen-enabled"), t)
              : (U.HTML.classList.add("fullscreen-disabled"), null)),
          U.ParentBibi &&
            ((U.ParentBibi.Window = window),
          ...
          throw (
            ...
            H.Veil.byebye({
              en:
                "<span>Sorry....</span> <span>Your Browser Is</span> <span>Not Compatible.</span>",
              ja:
        ...
        H.note('<span class="non-visual">Welcome!</span>'),
          (U.WritingModeProperty =
            ...
            /^(vertical|horizontal)-/.test(n["writing-mode"]) || sML.UA.Trident
              ? "writing-mode"
              : /^(vertical|horizontal)-/.test(n["-webkit-writing-mode"])
              ? "-webkit-writing-mode"
              : /^(vertical|horizontal)-/.test(n["-epub-writing-mode"])
              ? "-epub-writing-mode"
              : void 0));
        var n,
          i = U.Body.appendChild(
            sML.create("div", {
        ...
        (U.VerticalTextEnabled = i.offsetWidth < i.offsetHeight),
          ...
          W.dispatch(
            "bibi:initialized",
            (x.Status = x.Initialized = "Initialized")
          );
      }),
      (x.loadExtensions = function () {
        return new Promise(function (e, t) {
          ...
          var i = !1,
            r = !1;
          F.book
            ? (U.isToBeExtractedIfNecessary(F.book) && (i = !0),
              F.zine && (r = !0))
            : (F["accept-local-file"] || F["accept-blob-converted-data"]) &&
              (i = r = !0),
            r && n.unshift("zine.js"),
            (i
              ? (F.book
                  ? U.tryRangeRequest().then(function () {
                      return "on-the-fly";
                    })
                  : Promise.reject()
                )
              ...
              if (
                ...
                return t();
              U.log(
                "Loading Extension".concat(
                  F.extensions.length > 1 ? "s" : "",
                  "..."
                ),
                "<g:>"
              );
              !(function t(n) {
                X.load(F.extensions[n])
                  .then(function (e) {})
                  .catch(function (e) {
                    U.log(e);
                  })
          ...
          .then(function () {
            U.log("Extensions: %O", X.Extensions),
              U.log(
                X.Extensions.length
                  ? "Loaded. ("
                      .concat(X.Extensions.length, " Extension")
                      .concat(X.Extensions.length > 1 ? "s" : "", ")")
                  : "No Extension.",
                "</g>"
              );
          })
      ...
      (x.getBookData = function () {
        return F["book-data"]
          ...
          : Promise.reject(
              "Tell me EPUB name via ".concat(
                U.Embedded ? "embedding tag" : "URI",
                "."
              )
            );
      }),
      (x.setBookData = function (e) {
        return x.getBookData.resolve
          ? x.getBookData.resolve(e)
          : Promise.reject(e);
      }),
      ...
      (x.loadBook = function (e) {
        return Promise.resolve()
          ...
          .then(function () {
            return (
              U.log("Creating Cover...", "<g:>"),
              A.CoverImage.Source
                ? (U.log("Cover Image: %O", A.CoverImage.Source),
                  U.log("Will Be Created.", "</g>"))
                : U.log("Will Be Created. (w/o Image)", "</g>"),
              k.createCover()
            );
          })
          .then(function () {
            return A.Nav.Source
              ? (U.log("Loading Navigation...", "<g:>"),
          ...
          .then(function () {
                ...
                "object" == I(_.StartOn.Item)
                  ...
                  : (function () {
                      if ("number" == typeof _.StartOn.ItemIndex) {
                        ...
                        return (
                          e < 0
                            ? (_.StartOn = { ItemIndex: 0 })
                            : e >= _.Items.length &&
                              (_.StartOn = { ItemIndex: _.Items.length - 1 }),
                      ...
                      if ("number" == typeof _.StartOn.ItemIndexInSpine) {
                        ...
                        t < 0
                          ? (t = 0)
                          : t >= A.Package.Spine.length &&
                            (t = A.Package.Spine.length - 1);
                        var n = A.Package.Spine[_.StartOn.ItemIndexInSpine];
                        return (
                          n.Spread ||
                            ((_.StartOn = { ItemIndex: 0 }), (n = _.Items[0])),
                          n
                        );
                      }
                      if ("string" == typeof _.StartOn.P) {
                        ...
                        return (
                          i < 0
                            ? ((i = 0), (_.StartOn = { P: String(i + 1) }))
                            : i >= _.Items.length &&
                              ((i = _.Items.length - 1),
                              (_.StartOn = { P: String(i + 1) })),
                          _.Items[i]
                        );
                      }
            ...
            var i = 0;
            return (
              _.Spreads.forEach(function (n) {
                return e.push(
                  new Promise(function (e) {
                    return k
                      .loadSpread(n, {
                        AllowPlaceholderItems:
                          F["allow-placeholders"] &&
                          n.Index != t.TargetSpreadIndex,
                      })
                      .then(function () {
                        (i += n.Items.length),
                          H.note(
                            "Loading... ("
                              .concat(i, "/")
                              .concat(_.Items.length, " Items Loaded.)")
                          ),
              ...
              Promise.all(e).then(function () {
                return (
                  U.log(
                    "Loaded. ("
                      .concat(_.Items.length, " in ")
                      .concat(_.Spreads.length, ")"),
                    "</g>"
                  ),
                  t
                );
      ...
      (x.bindBook = function (e) {
        return (
          e.Reset || (_.organizePages(), _.layOutStage()),
      ...
      (x.openBook = function (e) {
        return new Promise(function (e) {
          ...
          H.History.List.length ||
            ...
            F["resume-from-last-position"] &&
              W.add("bibi:changed-intersection", function () {
                try {
                  U.Biscuits &&
                    U.Biscuits.memorize("Book", {
                      Position: { IIPP: H.PageObserver.getIIPP() },
                    });
                } catch (e) {}
              }),
            ...
            x.Dev && "localhost" != location.hostname
              ? x.createDevNote()
              : delete x.createDevNote;
        });
      }),
      (x.createDevNote = function () {
        var e = (x.IsDevMode = U.Body.appendChild(
          sML.create("div", { id: "bibi-is-dev-mode" })
        ));
        x.createDevNote.logBorderLine(),
          x.createDevNote.appendParagraph(
            "<strong>This Bibi seems to be a</strong> <strong>Development Version</strong>"
          ),
          x.createDevNote.appendParagraph(
      ...
      (x.createDevNote.appendParagraph = function (e, t) {
        var n = x.IsDevMode.appendChild(sML.create("p", { innerHTML: e }));
      ...
      (x.createElement = function () {
        for (var e, t = arguments.length, n = new Array(t), i = 0; i < t; i++)
          n[i] = arguments[i];
        var r = n[0];
        if ((x.Elements || (x.Elements = {}), window.customElements))
          x.Elements[r] ||
            ((x.Elements[r] = (function (e) {
              f(n, e);
              var t = g(n);
              function n() {
          ...
          return (
            x.Elements[r] || (x.Elements[r] = document.registerElement(r)),
      ...
      k = {
        ...
        initializeBook: function () {
          ...
          return new Promise(function (t, n) {
            ...
            if (
              ((A.Type = F.book ? (F.zine ? "Zine" : "EPUB") : ""),
              "EPUB" != A.Type &&
                (A.ZineData = { Source: { Path: "zine.yaml" } }),
              "URI" == r)
            ) {
              if (U.Local)
                return n(
                  "Bibi can't open books via ".concat(
                    N.book ? "data-bibi-book" : "URL",
                    " on local mode"
                  )
                );
              A.Path = e.Book;
              var o = ("Zine" == A.Type ? A.ZineData : A.Container).Source,
                ...
                s = function (e) {
                  return {
                    Promised: ("folder" == e
                      ? U.download(o).then(function () {
                          return (A.PathDelimiter = "/") && "";
                        })
                      : U.RangeLoader
                      ? U.extract(o).then(function () {
                          return "on-the-fly";
                        })
                      ...
                      .catch(function (t) {
                        return (
                          a.push(
                            (t = /404/.test(String(t))
                              ? x.ErrorMessages.NotFound
                              : String(t).replace(/^Error: /, ""))
                          ),
                          U.log(
                            "Failed as "
                              .concat(
                                /^[aiueo]/i.test(A.Type) ? "an" : "a",
                                " "
                              )
                              .concat(A.Type, " ")
                              .concat(e, ": ") + t
              ...
              U.isToBeExtractedIfNecessary(A.Path)
                ? s("file").or(function () {
              ...
              if ("File" == r) {
                ...
                if (!/\.[\w\d]+$/.test(l.name))
                  return n(
                    "Local file without extension is set to unacceptable"
                  );
                ...
                if (
                  ...
                  (/\.epub$/i.test(l.name)
                    ? !u.EPUB.test(l.type)
                    : !/\.zip$/i.test(l.name) || !u.Zine.test(l.type))
                )
              ...
              U.loadZippedBookData(l)
                .then(function () {
                  switch (A.Type) {
                    case "EPUB":
                    case "Zine":
                      return (
                        (A.ExtractionPolicy = "at-once"),
            ...
            return (
              ...
              ("Zine" == A.Type
                ? X.Zine.loadZineData()
                : k.loadContainer().then(k.loadPackage)
              )
                .then(function () {
        ...
        loadContainer: function () {
          return U.openDocument(A.Container.Source).then(
            k.loadContainer.process
          );
        },
      };
    (k.loadContainer.process = function (e) {
      return (A.Package.Source.Path = e
      ...
      (k.loadPackage.process = function (e) {
        ...
        (i["unique-identifier"] = p ? p.trim() : ""),
          ["identifier", "language", "title", "creator", "publisher"].forEach(
            function (t) {
          ...
          sML.forEach(n.getElementsByTagName("meta"))(function (e) {
            if (!e.getAttribute("refines")) {
              ...
              if (t)
                /^dcterms:/.test(t)
                  ? (i[t] || (i[t] = []), i[t].push(e.textContent.trim()))
                  : (i[t] = e.textContent.trim());
              else {
          ...
          (i["rendition:orientation"] &&
            "auto" != i["rendition:orientation"]) ||
            (i["rendition:orientation"] = "portrait"),
          (i["rendition:spread"] && "auto" != i["rendition:spread"]) ||
            (i["rendition:spread"] = "landscape"),
          i["original-resolution"] &&
            (i["original-resolution"] = U.getViewportByOriginalResolution(
              i["original-resolution"]
            )),
          i["rendition:viewport"] &&
            (i["rendition:viewport"] = U.getViewportByMetaContent(
              i["rendition:viewport"]
            )),
          i["fixed-layout-jp:viewport"] &&
            (i["fixed-layout-jp:viewport"] = U.getViewportByMetaContent(
              i["fixed-layout-jp:viewport"]
            )),
          i["omf:viewport"] &&
            (i["omf:viewport"] = U.getViewportByMetaContent(i["omf:viewport"])),
          (A.ICBViewport =
            i["original-resolution"] ||
            i["rendition:viewport"] ||
            i["fixed-layout-jp:viewport"] ||
        ...
        if (
          (sML.forEach(r.getElementsByTagName("item"))(function (e) {
            var t = {
            ...
            n &&
              ((n = n.trim().replace(/\s+/g, " ").split(" ")).includes(
                "cover-image"
              )
                ? (A.CoverImage.Source = t)
                : n.includes("nav") &&
                  ((A.Nav.Source = t), (A.Nav.Type = "Navigation Document")));
        ...
        A.Nav.Source && A.Nav.Source.Of.push(A.Nav),
          ...
          (A.PPD && /^(ltr|rtl)$/.test(A.PPD)) ||
            (A.PPD = F["default-page-progression-direction"]);
        var h,
          b,
          m = /^((rendition:)?(layout|orientation|spread|page-spread))-(.+)$/;
        "rtl" == A.PPD
          ? ((h = "right"), (b = "left"))
          : ((h = "left"), (b = "right"));
        ...
        sML.forEach(a.getElementsByTagName("itemref"))(function (e) {
          ...
          if (
            ...
            for (; r.Source.fallback; ) {
              ...
              a
                ? r.FallbackChain.push((r.Source = a))
                : delete r.Source.fallback;
            }
          r.Source.Of.push(r);
          var l = e.getAttribute("properties");
          if (
            (l &&
              (l = l.trim().replace(/\s+/g, " ").split(" ")).forEach(function (
                t
              ) {
                m.test(t) && (e[t.replace(m, "$1")] = t.replace(m, "$4"));
              }),
            (r["rendition:layout"] =
              e["rendition:layout"] || i["rendition:layout"]),
            (r["rendition:orientation"] =
              e["rendition:orientation"] || i["rendition:orientation"]),
            (r["rendition:spread"] =
              e["rendition:spread"] || i["rendition:spread"]),
            (r["rendition:page-spread"] =
              e["rendition:page-spread"] || e["page-spread"] || void 0),
            ...
            if (
              ...
              r["rendition:page-spread"] == b &&
              r.Index > 0
            ) {
              var d = _.Items[r.Index - 1];
              "pre-paginated" == r["rendition:layout"] &&
                d["rendition:page-spread"] == h &&
                ((d.SpreadPair = r),
                (r.SpreadPair = d),
                (u = r.Spread = d.Spread).Box.classList.remove(
                  "single-item-spread-before",
                  "single-item-spread-" + h
                ),
                u.Box.classList.add(r["rendition:layout"]));
            }
            if (!u) {
              if (
                (((u = r.Spread = sML.create("div", {
                  className: "spread",
                  Items: [],
                  Pages: [],
                ...
                switch (
                  (u.Box.classList.add(
                    "single-item-spread-" + r["rendition:page-spread"]
                  ),
                  r["rendition:page-spread"])
                ) {
                  case h:
            ...
            if (
              ((r.IndexInSpread = u.Items.push(r) - 1),
              (r.Box = u.appendChild(
                sML.create("div", {
        ...
        (A.WritingMode = /^(zho?|chi|kor?|ja|jpn)$/.test(A.Language)
          ? "rtl" == A.PPD
            ? "tb-rl"
            : "lr-tb"
          : /^(aze?|ara?|ui?g|urd?|kk|kaz|ka?s|ky|kir|kur?|sn?d|ta?t|pu?s|bal|pan?|fas?|per|ber|msa?|may|yid?|heb?|arc|syr|di?v)$/.test(
              A.Language
            )
          ? "rl-tb"
          : /^(mo?n)$/.test(A.Language)
          ? "tb-lr"
          : "lr-tb"),
          (A.AllowPlaceholderItems =
            "at-once" != A.ExtractionPolicy &&
            "pre-paginated" == i["rendition:layout"]),
      ...
      (k.createCover = function () {
        ...
        return (
          (t.Info.innerHTML = n.Info.innerHTML =
            ((e = []),
            A.Title &&
              e.push(
                "<strong>".concat(
                  k.createCover.optimizeString(A.Title),
                  "</strong>"
                )
              ),
            A.Creator &&
              e.push(
                "<em>".concat(k.createCover.optimizeString(A.Creator), "</em>")
              ),
            A.Publisher &&
              e.push(
                "<span>".concat(
                  k.createCover.optimizeString(A.Publisher),
                  "</span>"
                )
              ),
            e.join(" "))),
          Promise.resolve(
            new Promise(function (e, t) {
              ...
              U.file(A.CoverImage.Source, { URI: !0 })
                .then(function (t) {
                  n || e(t.URI);
                })
                .catch(function () {
              ...
              .then(function (e) {
                (t.className = n.className = "with-cover-image"),
                  sML.style(t, { "background-image": "url(" + e + ")" }),
                  n.insertBefore(sML.create("img", { src: e }), n.Info);
              })
              .catch(function () {
      ...
      (k.createCover.optimizeString = function (e) {
        return (
          "<span>" + e.replace(/([ 　・／]+)/g, "</span><span>$1") + "</span>"
        );
      }),
      (k.loadNavigation = function () {
        return U.openDocument(A.Nav.Source).then(function (e) {
          var t = (H.Panel.BookInfo.Navigation = H.Panel.BookInfo.insertBefore(
          ...
          if ("Navigation Document" == A.Nav.Type)
            ...
            var i = (function e(t) {
              for (
                var n = t.childNodes, i = void 0, r = n.length, o = 0;
                o < r;
                o++
              )
                if (1 == n[o].nodeType && /^navPoint$/i.test(n[o].tagName)) {
                  var a = n[o],
                    s =
                      (a.getElementsByTagName("navLabel")[0],
          ...
          for (
            var r = function (t, r) {
                ...
                sML.forEach(_.Items)(function (e) {
                  if (d == e.AnchorPath)
                    return (
                      o.setAttribute("data-bibi-original-href", a),
                      o.setAttribute(s, A.Path + "/" + l),
                      (o.InNav = n),
                      (o.Destination = { ItemIndex: e.Index }),
                      "pre-paginated" == e["rendition:layout"]
                        ? (o.Destination.PageIndexInItem = 0)
                        : p && (o.Destination.ElementSelector = "#" + p),
                    ...
                    X.EPUBCFI
                      ...
                      : o.addEventListener("click", function (e) {
                          return (
                            ...
                            H.note(
                              "ja" == U.Language
                                ? "<small>このリンクの利用には EPUBCFI エクステンションが必要です</small>"
                                : '"EPUBCFI" extension is required to use this link.'
                            ),
                            !1
                          );
                        })),
          ...
          return (
            ...
            e.Destination &&
              new Promise(function (t) {
                ...
                return k.Opened
                  ? (H.History.add(),
                    _.focusOn({ Destination: e.Destination, Duration: 0 }).then(
                      function (e) {
                  ...
                  : !!k.Waiting &&
                      (F["start-in-new-window"]
                        ...
                        : ((_.StartOn = e.Destination), void k.play()));
              }),
            !1
          );
        });
      ...
      (k.preprocessResources = function () {
        ...
        var e = [],
          ...
          n = function (n, i) {
            return e.push(
              U.file(n, { Preprocess: !0, URI: i }).then(function () {
                return t.push(n);
              })
            );
          };
        if (A.ExtractionPolicy)
          for (var i in A.Package.Manifest) {
            ...
            /\/(css|javascript)$/.test(r["media-type"]) &&
              (e.length || U.log("Preprocessing Resources...", "<g:>"),
              n(r, !0));
          }
        return Promise.all(e).then(function () {
          t.length &&
            (U.log("Preprocessed: %O", t),
            U.log(
              "Preprocessed. ("
                .concat(t.length, " Resource")
                .concat(t.length > 1 ? "s" : "", ")"),
              "</g>"
            )),
      ...
      (k.loadSpread = function (e) {
        ...
        return new Promise(function (n, i) {
          e.AllowPlaceholderItems =
            F["allow-placeholders"] && t.AllowPlaceholderItems;
          var r = 0,
            o = 0;
          e.Items.forEach(function (i) {
            k.loadItem(i, { IsPlaceholder: t.AllowPlaceholderItems })
              .then(function () {
                return r++;
              })
              .catch(function () {
      ...
      (k.loadItem = function (e) {
        ...
        return (
          ...
          (e.Loading = (e.IsPlaceholder
            ? Promise.reject()
            : e.ContentURL
            ? Promise.resolve()
            : /\.(html?|xht(ml)?|xml)$/i.test(e.Source.Path)
            ? U.file(e.Source, {
                Preprocess: A.ExtractionPolicy || sML.UA.Gecko,
                initialize: function () {
                  F["allow-scripts-in-content"] ||
                    ((e.Source.Content = e.Source.Content.replace(
                      /<script(\s+[\w\-]+(\s*=\s*('[^'']*'|"[^""]*"))?)*\s*\/>/gi,
                      ""
                    )),
                    U.sanitizeItemSource(e.Source, { As: "HTML" }));
                },
              }).then(function (e) {
                return e.Content;
              })
            : /\.(gif|jpe?g|png)$/i.test(e.Source.Path)
            ? U.file(e.Source, { URI: !0 }).then(function (t) {
                return [
                  "pre-paginated" == e["rendition:layout"] && A.ICBViewport
            ...
            ? U.file(e.Source, {
                ...
                initialize: function () {
                  ...
                  F["allow-scripts-in-content"] ||
                    U.sanitizeItemSource(e.Source, { As: "SVG" }),
                    (e.Source.Content =
                      (n
                        ? n
                            .map(function (e) {
            ...
            .then(function (t) {
              return new Promise(function (n) {
                if (!e.ContentURL) {
                  ...
                  if (
                    ((r = r.replace(
                      ...
                      '$1\n<link rel="stylesheet" id="'
                        .concat("bibi-default-style", '" href="')
                        .concat(x.BookStyleURL, '" />') +
                        (A.ExtractionPolicy || e.Source.Preprocessed
                          ? ""
                          : '\n<base href="'.concat(
                              U.fullPath(e.Source.Path),
                              '" />'
                            ))
                    )),
                    ...
                    return (
                      (r = r
                        ...
                        .replace(
                          "</head>",
                          "<script id=\"bibi-onload\">window.addEventListener('load', function() { parent.R.Items[".concat(
                            e.Index,
                            "].onLoaded(); return false; });</script>\n</head>"
                          )
                        )),
                      (e.onLoaded = function () {
                        n(),
                          e.contentDocument.head.removeChild(
                            e.contentDocument.getElementById("bibi-onload")
                          ),
                          delete e.onLoaded;
                      }),
                      (e.src = ""),
                  ...
                  (e.ContentURL = U.createBlobURL(
                    "Text",
                    r,
                    F["allow-scripts-in-content"] &&
                      /\.(xht(ml)?|xml)$/i.test(e.Source.Path)
      ...
      (k.postprocessItem = function (e) {
        ...
        n || i
          ? n
            ? i || e.HTML.setAttribute("lang", n)
            : e.HTML.setAttribute("xml:lang", i)
          : (e.HTML.setAttribute("xml:lang", A.Language),
          ...
          sML.UA.Trident &&
            sML.forEach(e.Body.getElementsByTagName("svg"))(function (e) {
              var t = e.getElementsByTagName("image");
              if (1 == t.length) {
                var n = t[0];
                n.getAttribute("width") &&
                  n.getAttribute("height") &&
                  (e.setAttribute("width", n.getAttribute("width")),
                  e.setAttribute("height", n.getAttribute("height")));
              }
            }),
          k.coordinateLinkages(e.Source.Path, e.Body);
        var r = e.contentDocument.querySelectorAll(
          "body>*:not(script):not(style)"
        );
        if (r && 1 == r.length) {
          var o = e.contentDocument.querySelector(
            "body>*:not(script):not(style)"
          );
          /^svg$/i.test(o.tagName)
            ? (e.Outsourcing = e.OnlySingleSVG = !0)
            : /^img$/i.test(o.tagName)
            ? (e.Outsourcing = e.OnlySingleIMG = !0)
            : /^iframe$/i.test(o.tagName)
            ? (e.Outsourcing = !0)
            : U.getElementInnerText(e.Body) || (e.Outsourcing = !0);
        }
        return ("pre-paginated" == e["rendition:layout"]
          ? Promise.resolve()
          : k.patchItemStyles(e)
        ).then(function () {
      ...
      (k.patchItemStyles = function (e) {
        return new Promise(function (t) {
          (e.StyleSheets = []),
            sML.forEach(e.HTML.querySelectorAll("link, style"))(function (t) {
              if (/^link$/i.test(t.tagName)) {
                ...
                if (
                  (sML.UA.Safari || sML.OS.iOS) &&
                  "alternate stylesheet" == t.rel
                )
                  return;
              }
          ...
          var n = function () {
            return (
              !(e.contentDocument.styleSheets.length < e.StyleSheets.length) &&
              (clearInterval(e.CSSLoadingTimerID),
          ...
          if (!e.Source.Preprocessed) {
            if (A.Package.Metadata["ebpaj:guide-version"]) {
              ...
              1 * t[0] == 1 &&
                1 * t[1] == 1 &&
                1 * t[2] <= 3 &&
                (e.Body.style.textUnderlinePosition = "under left");
            }
            if (sML.UA.Trident) {
              var n = /^(zho?|chi|kor?|ja|jpn)$/.test(A.Language);
              U.editCSSRules(e.contentDocument, function (e) {
                /(-(epub|webkit)-)?column-count: 1; /.test(e.cssText) &&
                  (e.style.columnCount = e.style.msColumnCount = "auto"),
                  /(-(epub|webkit)-)?writing-mode: vertical-rl; /.test(
                    e.cssText
                  ) && (e.style.writingMode = "tb-rl"),
                  /(-(epub|webkit)-)?writing-mode: vertical-lr; /.test(
                    e.cssText
                  ) && (e.style.writingMode = "tb-lr"),
                  /(-(epub|webkit)-)?writing-mode: horizontal-tb; /.test(
                    e.cssText
                  ) && (e.style.writingMode = "lr-tb"),
                  /(-(epub|webkit)-)?(text-combine-upright|text-combine-horizontal): all; /.test(
                    e.cssText
                  ) && (e.style.msTextCombineHorizontal = "all"),
                  n &&
                    / text-align: justify; /.test(e.cssText) &&
                    (e.style.textJustify = "inter-ideograph");
              });
            } else
              U.editCSSRules(e.contentDocument, function (e) {
                /(-(epub|webkit)-)?column-count: 1; /.test(e.cssText) &&
                  (e.style.columnCount = e.style.webkitColumnCount = "auto");
              });
          }
          var i = getComputedStyle(e.HTML),
            r = getComputedStyle(e.Body);
          i[U.WritingModeProperty] != r[U.WritingModeProperty] &&
            (e.HTML.style.writingMode = r[U.WritingModeProperty]),
            (e.WritingMode = U.getWritingMode(e.HTML)),
            /-rl$/.test(e.WritingMode)
              ? e.HTML.classList.add("bibi-vertical-text")
              : /-lr$/.test(e.WritingMode) &&
                e.HTML.classList.add("bibi-horizontal-text"),
            [
              [e.Box, i, e.HTML],
              [e, r, e.Body],
            ].forEach(function (e) {
    ...
    var _ = {
      ...
      createSpine: function (e) {
        (_.Main = U.Body.insertBefore(
          sML.create("main", { id: "bibi-main" }),
          U.Body.firstElementChild
        )),
          (_.Main.Book = _.Main.appendChild(
            sML.create("div", { id: "bibi-main-book" })
          )),
      ...
      resetBibiHeight: function () {
        ...
        return (
          U.TouchOS && (U.HTML.style.height = U.Body.style.height = e + "px"), e
        );
      },
      resetStage: function () {
        var e,
        ...
        (_.Stage = {}),
          ...
          (_.Main.Book.style.padding = _.Main.Book.style.width = _.Main.Book.style.height =
            "");
        var n =
          (F["use-slider"] && "paged" == F.RVM && U.Scrollbars[z.A_SIZE_B]
            ? U.Scrollbars[z.A_SIZE_B]
            : 0) +
          2 * F["spread-margin"];
        sML.style(
          _.Main.Book,
          (d((e = {}), z.A_SIZE_b, n > 0 ? "calc(100% - " + n + "px)" : ""),
          d(e, z.A_SIZE_l, ""),
          e)
        ),
          ...
          F["spread-margin"] > 0 &&
            (_.Main.Book.style["padding" + z.L_BASE_S] = _.Main.Book.style[
              "padding" + z.L_BASE_E
            ] = F["spread-margin"] + "px");
      },
      layOutSpreadAndItsItems: function (e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (1 == e.Items.length
          ? _.layOutItem(e.Items[0])
          : t.Reverse
          ? _.layOutItem(e.Items[1]).then(function () {
      ...
      layOutSpread: function (e) {
        ...
        return new Promise(function (n) {
          t.Makeover &&
            ((e.PreviousSpreadBoxLength = e.Box["offset" + z.L_SIZE_L]),
          ...
          if (1 == e.Items.length) {
            ...
            (e.Spreaded = !!o.Spreaded),
              (i.Width =
                e.Spreaded &&
                "pre-paginated" == o["rendition:layout"] &&
                o["rendition:page-spread"]
                  ? A.ICBViewport
                    ? (o.Box.offsetHeight * A.ICBViewport.Width * 2) /
                      A.ICBViewport.Height
                    : _.Stage.Width
                  : o.Box.offsetWidth),
            ...
            (e.Spreaded = !(!a.Spreaded && !s.Spreaded)),
              "pre-paginated" == a["rendition:layout"] &&
              "pre-paginated" == s["rendition:layout"]
                ? e.Spreaded || "vertical" != F.RVM
                  ? ((i.Width = a.Box.offsetWidth + s.Box.offsetWidth),
                    (i.Height = Math.max(
                      a.Box.offsetHeight,
                      s.Box.offsetHeight
                    )))
                  : ((i.Width = Math.max(a.Box.offsetWidth, s.Box.offsetWidth)),
                    (i.Height = a.Box.offsetHeight + s.Box.offsetHeight))
                : "horizontal" == F.SLA
                ? ((i.Width = a.Box.offsetWidth + s.Box.offsetWidth),
                  (i.Height = Math.max(a.Box.offsetHeight, s.Box.offsetHeight)),
                  x.Dev &&
                    (U.log("Paired Items incl/Reflowable (Horizontal)", "<g:>"),
                    U.log(
                      "[0] w"
                        .concat(a.Box.offsetWidth, "/h")
                        .concat(a.Box.offsetHeight, " %O"),
                      a
                    ),
                    U.log(
                      "[1] w"
                        .concat(s.Box.offsetWidth, "/h")
                        .concat(s.Box.offsetHeight, " %O"),
                      s
                    ),
                    U.log(
                      "-=> w".concat(i.Width, "/h").concat(i.Height, " %O"),
                      e,
                      "</g>"
                    )))
                : ((i.Width = Math.max(a.Box.offsetWidth, s.Box.offsetWidth)),
                  (i.Height = a.Box.offsetHeight + s.Box.offsetHeight),
                  x.Dev &&
                    (U.log("Paired Items incl/Reflowable (Vertical)", "<g:>"),
                    U.log(
                      "[0] w"
                        .concat(a.Box.offsetWidth, "/h")
                        .concat(a.Box.offsetHeight, " %O"),
          ...
          var c =
            "paged" == F.RVM ||
            (0 != e.Index && e.Index != _.Spreads.length - 1)
              ? 0
              : Math.floor((_.Stage[z.L_SIZE_L] - i[z.L_SIZE_L]) / 2);
          if (
            (c > 0
              ? (0 == e.Index &&
                  ((e.style["padding" + z.L_BASE_B] = c + "px"),
                  (i[z.L_SIZE_L] += c)),
                e.Index == _.Spreads.length - 1 &&
                  ((e.style["padding" + z.L_BASE_A] = c + "px"),
                  (i[z.L_SIZE_L] += c)))
              : (e.style.padding = ""),
            U.Scrollbars.Height && "vertical" == F.SLA && "vertical" != F.ARA
              ? ((r.style.minHeight =
                  "paged" == F.RVM
                    ? "calc(100vh - " + U.Scrollbars.Height + "px)"
                    : ""),
                (r.style.marginBottom =
                  e.Index == _.Spreads.length - 1
                    ? U.Scrollbars.Height + "px"
                    : ""))
              : (r.style.minHeight = r.style.marginBottom = ""),
            r.classList.toggle("spreaded", e.Spreaded),
            (r.style[z.L_SIZE_b] = ""),
            (e.style[z.L_SIZE_b] = Math.ceil(i[z.L_SIZE_B]) + "px"),
            (r.style[z.L_SIZE_l] = e.style[z.L_SIZE_l] =
              Math.ceil(i[z.L_SIZE_L]) + "px"),
            t.Makeover)
          ) {
            ...
            if (0 != l) {
              var u =
                "X" == z.L_AXIS_L &&
                U.getElementCoord(e, _.Main).X + e.offsetWidth <=
                  _.Main.scrollLeft + _.Main.offsetWidth;
              (_.Main.Book.style[z.L_SIZE_l] =
                parseFloat(getComputedStyle(_.Main.Book)[z.L_SIZE_l]) +
                l +
                "px"),
                u &&
                  ((_.Main.scrollLeft += l),
      ...
      layOutItem: function (e) {
        return new Promise(function (t) {
          (e.Scale = 1),
            "pre-paginated" != e["rendition:layout"]
              ? _.renderReflowableItem(e)
              : _.renderPrePaginatedItem(e),
            t(e);
        });
      },
      renderReflowableItem: function (e) {
        var t,
          n,
          i,
          r = F["item-padding-" + z.L_BASE_s] + F["item-padding-" + z.L_BASE_e],
        ...
        ["b", "a", "s", "e"].forEach(function (t) {
          ...
          sML.style(e.HTML, { width: "", height: "" }),
          e.WithGutters &&
            (e.HTML.classList.remove("bibi-with-gutters"),
        ...
        if (
          (e.Columned &&
            ...
            l &&
              e.ReversedColumned &&
              ((e.HTML.style.direction = ""),
              sML.forEach(e.contentDocument.querySelectorAll("body > *"))(
                function (e) {
          ...
          (e.Spreaded =
            "horizontal" == F.SLA &&
            ("x" == F["pagination-method"] || /-tb$/.test(e.WritingMode)) &&
            ("both" == e["rendition:spread"] ||
              _.Orientation == e["rendition:spread"] ||
              "landscape" == _.Orientation)),
          e.Spreaded)
        ) {
          var u = Math.floor((s - c) / 2);
          u >= Math.floor((a * F["orientation-border-ratio"]) / 2)
            ? (s = u)
            : (e.Spreaded = !1);
        }
        sML.style(
          e,
          (d((t = {}), z.L_SIZE_b, a + "px"), d(t, z.L_SIZE_l, s + "px"), t)
        );
        var p = sML.appendCSSRule(
          e.contentDocument,
          "*",
        ...
        sML.forEach(e.Body.querySelectorAll("img, svg"))(function (t) {
          ...
          if (
            t.BibiDefaultStyle &&
            (["width", "height", "maxWidth", "maxHeight"].forEach(function (e) {
              return (t.style[e] = t.BibiDefaultStyle[e]);
            }),
            !(
              ("horizontal" == F.RVM && /-(rl|lr)$/.test(e.WritingMode)) ||
              ("vertical" == F.RVM && /-tb$/.test(e.WritingMode))
            ))
          ) {
            var i = parseFloat(getComputedStyle(t)[z.L_SIZE_b]),
              r = Math.floor(
                Math.min(parseFloat(getComputedStyle(e.Body)[z.L_SIZE_b]), a)
              ),
              o = parseFloat(getComputedStyle(t)[z.L_SIZE_l]),
              c = Math.floor(
                Math.min(parseFloat(getComputedStyle(e.Body)[z.L_SIZE_l]), s)
              );
            (i > r || o > c) &&
              sML.style(
                t,
                (d(
                  ...
                  z.L_SIZE_b,
                  Math.floor(
                    parseFloat(getComputedStyle(t)[z.L_SIZE_b]) *
                      Math.min(r / i, c / o)
                  ) + "px"
                ),
                d(n, z.L_SIZE_l, "auto"),
        ...
        switch (
          (e.Outsourcing ||
            ("x" == F["pagination-method"]
              ? "paged" == F.RVM && e.HTML["offset" + z.L_SIZE_L] > s
                ? (f = "S")
                : e.HTML["offset" + z.L_SIZE_B] > a && (f = "C")
              : ("paged" == F.RVM || e.HTML["offset" + z.L_SIZE_B] > a) &&
                (f = "C")),
          f)
        ) {
          case "S":
            ...
            var g = Math.ceil(
              (sML.UA.Trident ? e.Body.clientHeight : e.HTML.scrollHeight) / a
            );
            sML.style(e.HTML, {
              width: "",
              height: "",
            ...
            var M = x.createElement("bibi-neck"),
              ...
              B = E.attachShadow
                ...
                ? E.createShadowRoot()
                : E;
            (B.appendChild(document.createElement("style")).textContent =
              (B != E ? ":host" : "bibi-throat") +
              " { "
                .concat(z.L_SIZE_b, ": ")
                .concat(a, "px; ")
                .concat(z.L_SIZE_l, ": ")
                .concat(h, "px; shape-outside: polygon(")
                .concat(L.join(", "), "); }")),
        ...
        var A = sML.UA.Trident
            ? e.Body["client" + z.L_SIZE_L]
            : e.HTML["scroll" + z.L_SIZE_L],
          k = Math.ceil((A + c) / (s + c));
        (A = (s + c) * k - c),
        ...
        (e.Box.style[z.L_SIZE_b] = O + "px"),
          ...
          (e.Pages = []);
        for (var R = 0; R < k; R++) {
          var N = e.Box.appendChild(sML.create("span", { className: "page" }));
          (N.Item = e),
            (N.Spread = e.Spread),
      ...
      renderPrePaginatedItem: function (e) {
        ...
        (e.Spreaded = !(
          ("paged" != F.RVM && F["full-breadth-layout-in-scroll"]) ||
          ("both" != e["rendition:spread"] &&
            _.Orientation != e["rendition:spread"] &&
            "landscape" != _.Orientation)
        )),
        ...
        if (e.Spreaded)
          if (((i = _.getItemLayoutViewport(e)), e.SpreadPair)) {
            ...
            var d = {
              Width:
                i.Width *
                (/^(left|right)$/.test(e["rendition:page-spread"]) ? 2 : 1),
              Height: i.Height,
            };
          ...
          (i = _.getItemLayoutViewport(e)),
            "paged" != F.RVM && F["full-breadth-layout-in-scroll"]
              ? (e.Scale = t / i[z.L_SIZE_B])
              : (e.Scale = Math.min(t / i[z.L_SIZE_B], n / i[z.L_SIZE_L]));
        var p = Math.floor(i[z.L_SIZE_L] * e.Scale),
          f = Math.floor(i[z.L_SIZE_B] * (p / i[z.L_SIZE_L]));
        return (
          (e.Box.style[z.L_SIZE_l] = p + "px"),
      ...
      getItemViewport: function (e) {
        return e.IsPlaceholder
          ? null
          : (t = e.Head.querySelector('meta[name="viewport"]'))
          ? U.getViewportByMetaContent(t.getAttribute("content"))
          : e.OnlySingleSVG
          ? U.getViewportByViewBox(
              e.Body.firstElementChild.getAttribute("viewBox")
            )
          : e.OnlySingleIMG
          ? U.getViewportByImage(e.Body.firstElementChild)
          : null;
        var t;
      },
      getItemLayoutViewport: function (e) {
        return e.Viewport
          ...
          : {
              Width:
                (_.Stage.Height * F["orientation-border-ratio"]) /
                (/^(left|right)$/.test(e["rendition:page-spread"]) ? 2 : 1),
      ...
      layOutStage: function () {
        ...
        _.Spreads.forEach(function (t) {
          ...
          ("pre-paginated" != F["book-rendition-layout"] &&
            "paged" == F["reader-view-mode"]) ||
            (e += F["spread-gap"] * (_.Spreads.length - 1)),
      ...
      layOutBook: function (e) {
        return new Promise(function (t, n) {
          ...
          (H.ScrollObserver.History = []),
            ...
            e.Destination ||
              (e.Destination = { IIPP: H.PageObserver.getIIPP() }),
          ...
          .then(function () {
            return _.focusOn({ Destination: e.Destination, Duration: 0 });
          })
          .then(function () {
            (U.Busy = !1),
              U.HTML.classList.remove("busy"),
      ...
      updateOrientation: function () {
        ...
        if (void 0 !== window.orientation)
          ...
          var t =
              window.innerWidth -
              ("vertical" == F.ARA ? U.Scrollbars.Width : 0),
            n =
              window.innerHeight -
              ("horizontal" == F.ARA ? U.Scrollbars.Height : 0);
          _.Orientation =
            t / n < F["orientation-border-ratio"] ? "portrait" : "landscape";
        }
        _.Orientation != e &&
          (e && W.dispatch("bibi:changes-orientation", _.Orientation),
      ...
      changeView: function (e) {
        if (
          F["fix-reader-view-mode"] ||
          !e ||
          "string" != typeof e.Mode ||
          !/^(paged|horizontal|vertical)$/.test(e.Mode) ||
          (F.RVM == e.Mode && !e.Force)
        )
          return !1;
        if (k.Opened) {
        ...
        } else F.update({ "reader-view-mode": e.Mode }), k.play();
        F["keep-settings"] &&
          U.Biscuits &&
          U.Biscuits.memorize("Book", { RVM: e.Mode });
      },
    };
    Object.defineProperties(_, {
      ...
      (_.focusOn = function (e) {
        return new Promise(function (t, n) {
          ...
          W.dispatch("bibi:is-going-to:focus-on", e),
            (_.Moving = !0),
            (e.FocusPoint = 0),
            "reflowable" == F["book-rendition-layout"]
              ? ("number" == typeof i.Point
                  ? (e.FocusPoint = i.Point)
                  : ((e.FocusPoint = U.getElementCoord(i.Page)[z.L_AXIS_L]),
                    "after" == i.Side &&
                      (e.FocusPoint +=
                        (i.Page["offset" + z.L_SIZE_L] - _.Stage[z.L_SIZE_L]) *
                        z.L_AXIS_D),
                    "rtl" == F.SLD && (e.FocusPoint += i.Page.offsetWidth)),
                "rtl" == F.SLD && (e.FocusPoint -= _.Stage.Width))
              : _.Stage[z.L_SIZE_L] >= i.Page.Spread["offset" + z.L_SIZE_L]
              ? ((e.FocusPoint = U.getElementCoord(i.Page.Spread)[z.L_AXIS_L]),
                (e.FocusPoint -= Math.floor(
                  (_.Stage[z.L_SIZE_L] - i.Page.Spread["offset" + z.L_SIZE_L]) /
                    2
                )))
              : ((e.FocusPoint = U.getElementCoord(i.Page)[z.L_AXIS_L]),
                _.Stage[z.L_SIZE_L] > i.Page["offset" + z.L_SIZE_L]
                  ? (e.FocusPoint -= Math.floor(
                      (_.Stage[z.L_SIZE_L] - i.Page["offset" + z.L_SIZE_L]) / 2
                    ))
                  : "after" == i.Side &&
                    (e.FocusPoint +=
                      (i.Page["offset" + z.L_SIZE_L] - _.Stage[z.L_SIZE_L]) *
          ...
          var r = { Frame: _.Main, X: 0, Y: 0 };
          return (
            (r[z.L_AXIS_L] = e.FocusPoint),
            F["use-full-height"] ||
              "vertical" != F.RVM ||
              (r.Y -= H.Menu.Height),
            sML
      ...
      (_.hatchDestination = function (e) {
        ...
        if (
          "reflowable" == F.BRL &&
          (("vertical" == F.SLA && /-tb$/.test(A.WritingMode)) ||
            ("horizontal" == F.SLA && /^tb-/.test(A.WritingMode))) &&
          (e.P & /\./.test(e.P) || e.Element || e.ElementSelector)
        )
          return (e.Point = _.hatchPoint(e)), e;
        if ((delete e.Point, e.Page)) {
          if (_.Pages[e.Page.Index] == e.Page) return e;
          delete e.Page;
        }
        if ("number" == typeof e || ("string" == typeof e && /^\d+$/.test(e)))
          return { Page: _.Items[e].Pages[0] };
        if ("string" == typeof e)
          "head" == e || "foot" == e
            ? (e = { Edge: e })
            : X.EPUBCFI && (e = X.EPUBCFI.getDestination(e));
        else if ("number" == typeof e.IndexInItem) {
          if (_.Pages[e.Index] == e) return { Page: e };
        } else {
          if ("number" == typeof e.Index) return { Page: e.Pages[0] };
          e.tagName && (e = { Element: e });
        }
      ...
      (_.hatchPage = function (e) {
        if (
          ("string" == typeof e.P &&
            e.P &&
            Object.assign(e, _.getPDestination(e.P)),
          e.Page)
        )
          return e.Page;
        if ("number" == typeof e.PageIndex) return _.Pages[e.PageIndex];
        if (
          ("number" == typeof e.SIPP &&
            (("number" != typeof e.PageIndexInSpread &&
              "number" != typeof e.PageProgressInSpread) ||
              ("number" != typeof e.SpreadIndex && !e.Spread)) &&
            ((e.SpreadIndex = Math.floor(e.SIPP)),
            (e.PageProgressInSpread =
              1 * String(e.SIPP).replace(/^\d*\./, "0."))),
          "number" == typeof e.IIPP &&
            (("number" != typeof e.PageIndexInItem &&
              "number" != typeof e.PageProgressInItem) ||
              ("number" != typeof e.ItemIndex && !e.Item)) &&
            ((e.ItemIndex = Math.floor(e.IIPP)),
            (e.PageProgressInItem =
              1 * String(e.IIPP).replace(/^\d*\./, "0."))),
          "head" == e.Edge)
        )
          return _.Pages[0];
        ...
        try {
          if (
            ("string" == typeof e.ElementSelector &&
              (e.Item || (e.Item = _.hatchItem(e)),
              e.Item &&
                (e.Element = e.Item.contentDocument.querySelector(
                  e.ElementSelector
                )),
          ...
          return "number" == typeof e.PageIndexInItem
            ? _.hatchItem(e).Pages[e.PageIndexInItem]
            : "number" == typeof e.PageIndexInSpread
            ? _.hatchSpread(e).Pages[e.PageIndexInSpread]
            : "number" == typeof e.PageProgressInItem
            ? (i = _.hatchItem(e)).Pages[
                sML.limitMax(
                  Math.floor(i.Pages.length * e.PageProgressInItem),
                  i.Pages.length - 1
                )
              ]
            : "number" == typeof e.PageProgressInSpread
            ? (n = _.hatchSpread(e)).Pages[
                sML.limitMax(
                  Math.floor(n.Pages.length * e.PageProgressInSpread),
                  n.Pages.length - 1
                )
              ]
            : (_.hatchItem(e) || _.hatchSpread(e)).Pages[0];
        } catch (e) {}
        var n, i;
        return null;
      }),
      ...
      (_.hatchNearestPageOfElement = function (e) {
        ...
        var t,
          n,
          i = e.ownerDocument.body.Item;
        return i && i.Pages
          ? (i.Columned
              ? ((n = U.getElementCoord(e)[z.L_AXIS_B]),
                "rtl" == F.PPD &&
                  "vertical" == F.SLA &&
                  (n = i.Body.offsetWidth - n - e.offsetWidth),
                (t = i.Pages[n <= 0 ? 0 : Math.floor(n / i.ColumnBreadth)]))
              : ((n = U.getElementCoord(e)[z.L_AXIS_L]),
                "rtl" == F.PPD &&
                  "horizontal" == F.SLA &&
                  (n = i.HTML.offsetWidth - n - e.offsetWidth),
        ...
        try {
          if (
            ("string" == typeof e.P &&
              ...
              Object.assign(e, _.getPDestination(e.P)),
            "string" == typeof e.ElementSelector &&
              ((e.Element = _.hatchItem(e).contentDocument.querySelector(
                e.ElementSelector
              )),
              delete e.ElementSelector),
            e.Element)
      ...
      (_.hatchPointOfElement = function (e) {
        if (!e || !e.tagName) return null;
        var t,
          n = e.ownerDocument.body.Item;
        return n && n.Pages
          ? (n.Columned
              ? ((t = U.getElementCoord(e)[z.L_AXIS_B]),
                "rtl" == F.PPD &&
                  "vertical" == F.SLA &&
                  (t = n.Body.offsetWidth - t - e.offsetWidth))
              : ((t = U.getElementCoord(e)[z.L_AXIS_L]),
                "rtl" == F.PPD &&
                  "horizontal" == F.SLA &&
                  (t += e.offsetWidth)),
            U.getElementCoord(n)[z.L_AXIS_L] +
              F["item-padding-" + z.L_OOBL_l] +
              t)
          : null;
      }),
      (_.getPDestination = function (e) {
        ...
        if (/^[a-z]+$/.test(e))
          return "head" == e || "foot" == e ? { Edge: e } : null;
        var t = e.split(/-[a-z]+$/.test(e) ? "-" : "."),
          n = parseInt(t.shift()) - 1;
        if (n < 0) return { Edge: "head" };
        if (n > _.Items.length - 1) return { Edge: "foot" };
        var i = _.Items[n];
        if (t.length)
          if (/^[a-z]+$/.test(t[0])) {
            if ("end" == t[0]) return { Page: i.Pages[i.Pages.length - 1] };
          } else {
            var r = "body";
            ...
            if (o) return { Element: o };
          }
        return { Page: i.Pages[0] };
      }),
      (_.selectTextLocation = function (e) {
        ...
        if (t && t.textContent) {
          var n = {
            Start: { Node: t, Index: 0 },
            End: { Node: t, Index: t.textContent.length },
          };
          if (e.TermStep)
            if (e.TermStep.Preceding || e.TermStep.Following) {
              if (
                ((n.Start.Index = e.TermStep.Index),
                (n.End.Index = e.TermStep.Index),
                e.TermStep.Preceding &&
                  (n.Start.Index -= e.TermStep.Preceding.length),
                e.TermStep.Following &&
                  (n.End.Index += e.TermStep.Following.length),
              ...
              if (
                t.textContent.substr(
                  n.Start.Index,
                  n.End.Index - n.Start.Index
                ) !=
                e.TermStep.Preceding + e.TermStep.Following
              )
                return;
            } else if (e.TermStep.Side && "a" == e.TermStep.Side) {
              for (
                n.Start.Node = t.parentNode.firstChild;
                n.Start.Node.childNodes.length;
              ...
              for (
                n.Start.Index = e.TermStep.Index,
                  n.End.Node = t.parentNode.lastChild;
                n.End.Node.childNodes.length;
      ...
      (_.moveBy = function (e) {
        return new Promise(function (t, n) {
          ...
          var i = (e.Distance > 0
              ? H.PageObserver.Current.List.slice(-1)
              : H.PageObserver.Current.List)[0],
            r = i.Page,
            o = (r.Item, e.Distance > 0 ? "before" : "after");
          i.PageIntersectionStatus.Oversized
            ? e.Distance > 0
              ? i.PageIntersectionStatus.Entering
                ? ((e.Distance = 0), (o = "before"))
                : i.PageIntersectionStatus.Headed &&
                  ((e.Distance = 0), (o = "after"))
              : (i.PageIntersectionStatus.Footed ||
                  i.PageIntersectionStatus.Passing) &&
                ((e.Distance = 0), (o = "before"))
            : e.Distance > 0
            ? i.PageIntersectionStatus.Entering &&
              ((e.Distance = 0), (o = "before"))
          ...
          a < 0
            ? ((a = 0), (o = "before"))
            : a > _.Pages.length - 1 &&
              ((a = _.Pages.length - 1), (o = "after"));
          var s = _.Pages[a];
          "pre-paginated" == F.BRL &&
            s.Item.SpreadPair &&
            "horizontal" == F.SLA &&
            _.Stage[z.L_SIZE_L] > s.Spread["offset" + z.L_SIZE_L] &&
            (e.Distance < 0 && 0 == s.IndexInSpread && (s = s.Spread.Pages[1]),
            e.Distance > 0 && 1 == s.IndexInSpread && (s = s.Spread.Pages[0])),
            (e.Destination = { Page: s, Side: o }),
            _.focusOn(e)
              .then(function () {
    ...
    (H.Utilities = {
        ...
        var e = (H.Utilities = H.setToggleAction(
          {
            openGracefuly: function () {
              return (
                !_.Moving && !_.Breaking && "active" != e.UIState && e.open()
              );
            },
            closeGracefuly: function () {
              return (
                !_.Moving && !_.Breaking && "default" != e.UIState && e.close()
              );
            },
        ...
        create: function () {
          var e = (H.PageObserver = {
            ...
            observePageIntersection: function (t) {
              return e.PagesToBeObserved.includes(t)
                ? e.PagesToBeObserved.length
                : e.PagesToBeObserved.push(t);
            },
            unobservePageIntersection: function (t) {
              return (e.PagesToBeObserved = e.PagesToBeObserved.filter(
                function (e) {
                  return e != t;
                }
              )).length;
                ...
                function (t) {
                  return t.forEach(function (t) {
                    var n = t.target,
                      i = !1;
                    t.isIntersecting
                      ? e.IntersectingPages.includes(n) ||
                        ((i = !0), e.IntersectingPages.push(n))
                      : e.IntersectingPages.includes(n) &&
                        ((i = !0),
                        (e.IntersectingPages = e.IntersectingPages.filter(
                          function (e) {
                            return e != n;
                          }
                        ))),
                      i &&
                        (e.IntersectingPages.length &&
                          e.IntersectingPages.sort(function (e, t) {
                            return e.Index - t.Index;
                          }),
                        W.dispatch(
                          "bibi:changes-intersection",
                          e.IntersectingPages
                        ),
                        clearTimeout(e.Timer_IntersectionChange),
                        (e.Timer_IntersectionChange = setTimeout(function () {
                          W.dispatch(
                            "bibi:changed-intersection",
                            e.IntersectingPages
                          );
                        }, 9)));
                  });
                },
                { root: _.Main, rootMargin: "0px", threshold: 0 }
              );
            ...
            getFrame: function () {
              var e = {};
              return (
                (e.Length = _.Main["offset" + z.L_SIZE_L]),
                (e[z.L_OOBL_L] = Math.ceil(_.Main["scroll" + z.L_OOBL_L])),
                (e["Top" == z.L_OOBL_L ? "Bottom" : "Right"] =
                  e[z.L_OOBL_L] + e.Length),
                {
                  Before: e[z.L_BASE_B],
                  After: e[z.L_BASE_A],
                  Length: e.Length,
            ...
            getCandidatePageList: function () {
              for (
                var t = Math.ceil((_.Stage.Width - 1) / 4),
                  n = Math.ceil((_.Stage.Height - 1) / 4),
                  i = [5, 6, 4, 2, 8],
                  r = i.length,
                  o = 0;
                o < r;
            ...
            getList: function () {
              ...
              for (
                var r = sML.limitMin(i[0].Index - 2, 0),
                  o = sML.limitMax(
                    i[i.length - 1].Index + 2,
                    _.Pages.length - 1
                  ),
                  a = 0,
                  s = r;
                ...
                if (l.Ratio < a) {
                  ...
                  var u = { Page: c, PageIntersectionStatus: l };
                  if (t.length) {
                    var d = t[t.length - 1];
                    d.Page.Item == c.Item &&
                      (u.ItemIntersectionStatus = d.ItemIntersectionStatus),
                      d.Page.Spread == c.Spread &&
                        (u.SpreadIntersectionStatus =
                          d.SpreadIntersectionStatus);
                  }
                  u.ItemIntersectionStatus ||
                    (u.ItemIntersectionStatus = e.getIntersectionStatus(
                      c.Item.Box
                    )),
                    u.SpreadIntersectionStatus ||
                      (u.SpreadIntersectionStatus = e.getIntersectionStatus(
                        c.Spread
                      )),
                    1 == u.SpreadIntersectionStatus.Ratio && n.push(u),
                    l.Ratio > a ? ((t = [u]), (a = l.Ratio)) : t.push(u);
                }
              }
            ...
            getIntersectionStatus: function (t, n) {
              var i = sML.getCoord(t),
                r = z.L_AXIS_D,
                o =
                  Math.min(e.Current.Frame.After * r, i[z.L_BASE_A] * r) -
                  Math.max(e.Current.Frame.Before * r, i[z.L_BASE_B] * r),
                a =
                  o <= 0 || !i[z.L_SIZE_L] || isNaN(o) ? 0 : o / i[z.L_SIZE_L],
                s = { Ratio: a };
              if (a <= 0);
              else if (n)
            ...
            classify: function () {
              ...
              e.Current.List.forEach(function (e) {
                var n = e.Page,
                  i = n.Item.Box,
                  r = n.Spread.Box;
                t.includes(r) || (r.classList.add("current"), t.push(r)),
                  t.includes(i) || (i.classList.add("current"), t.push(i)),
            ...
            observeCurrent: function () {
              W.bind(
                ["bibi:changed-intersection", "bibi:scrolled"],
                e.updateCurrent
              );
            },
            ...
            observePageMove: function () {
              W.bind("bibi:scrolled", function () {
                ...
                if (i != l || r != u)
                  ...
                  0 != i.Index ||
                    (!o.Contained && !o.Headed) ||
                    h.Contained ||
                    h.Headed ||
                    (f = !0),
                    r.Index != d ||
                      (!a.Contained && !a.Footed) ||
                      b.Contained ||
                      b.Footed ||
                      (g = !0);
                }
                var m = { Past: e.Past, Current: e.Current };
            ...
            getIIPP: function () {
              var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : {},
                n =
                  t.Page && "number" == typeof t.Page.IndexInItem
                    ? t.Page
                    : e.Current.Pages[0] ||
                      (t.Item && t.Item.IndexInSpine
                        ? t.Item.Pages[0]
                        : _.Pages[0]);
            ...
            getP: function () {
              ...
              if (
                t.Element &&
                t.Element.ownerDocument &&
                t.Element.ownerDocument.body.Item
              )
                (n = t.Element.ownerDocument.body.Item), (i = t.Element);
              else {
                if ("pre-paginated" == A.Package.Metadata["rendition:layout"])
                  return {
                    P: String(
                      (e.Current.Pages[0] || _.Pages[0]).Item.Index + 1
                    ),
                  };
                (t.Page && "number" == typeof t.Page.IndexInItem) ||
                  (t.Page = null);
                var r = t.Page
                  ? t.Page
                  : ("tb" == A.WritingMode.split("-")[0] &&
                      "vertical" == F.SLA) ||
                    ("tb" == A.WritingMode.split("-")[1] &&
                      "horizontal" == F.SLA)
                  ? e.Current.Pages[0]
                  : e.IntersectingPages.filter(function (t) {
                      return (
                        _.Stage[z.L_SIZE_L] * e.getIntersectionStatus(t).Ratio >
                        3
                      );
                    })[0];
                if (!r) return "";
                ...
                (a[z.L_OOBL_B] += F["item-padding-" + z.L_OOBL_b]),
                  ...
                  n.Columned &&
                    ((a[z.L_OOBL_L] += F["item-padding-" + z.L_OOBL_l]),
                ...
                "rtl" == F.ARD
                  ...
                  t.TagNames &&
                    (t.TagNames = Array.isArray(t.TagNames)
                      ? t.TagNames.map(function (e) {
                ...
                e: for (
                  var g = u[z.A_BASE_B],
                    h = Math.round((u[z.A_BASE_A] - u[z.A_BASE_B]) / 9);
                  g * d < u[z.A_BASE_A] * d;
                  g += h
                )
                  for (
                    var b = u[z.A_BASE_S],
                      m = Math.round((u[z.A_BASE_E] - u[z.A_BASE_S]) / 3);
                    b * p < u[z.A_BASE_E] * p;
                    b += m
                  ) {
                    var v = f(g, b);
                    if (
                      (t.TagNames
                        ? t.TagNames.includes(v.tagName.toLowerCase()) &&
                          (i = v)
                        : v != n.HTML && v != n.Body && (i = v),
                      i)
                    )
                      break e;
                  }
                if (!i)
                  return r.IndexInItem < n.Pages.length - 1
                    ? e.getP({
                        Page: n.Pages[r.IndexInItem + 1],
                        TagNames: t.TagNames,
                      })
                    : n.Index < _.Items.length - 1
                    ? n.Index + 2
                    : "foot";
              }
              for (
                    ...
                    sML.forEach(y.parentElement.childNodes)(function (t, n) {
                      if (1 == t.nodeType)
                        return (
                          e++,
                          t == y
                            ? (S.unshift(e), (y = y.parentElement), "break")
                            : void 0
                        );
                    });
                  };
            ...
            turnItems: function (t) {
              if (!_.DoNotTurn && F["allow-placeholders"]) {
                "object" != I(t) && (t = {});
                var n =
                    H.ScrollObserver.History.length > 1 &&
                    H.ScrollObserver.History[1] * z.L_AXIS_D >
                      H.ScrollObserver.History[0] * z.L_AXIS_D
                      ? -1
                      : 1,
                ...
                if (i) {
                  ...
                  c && r.push(c),
                    r.forEach(function (t) {
                      "Up" != t.Turned &&
                        (e.TurningItems_FaceUp.includes(t) ? a : o).push(t);
                    });
                  for (
                    var l = 1;
                    ++l < 9 && a.length + o.length < e.MaxTurning;
            ...
            turnItem: function (t, n) {
              return new Promise(function (i) {
                if (!_.DoNotTurn && F["allow-placeholders"]) {
                  if (
                    (t || (t = e.getTurningOriginItem()),
                    "object" != I(n) && (n = { Up: !0 }),
                    n.Up)
                  ) {
                    if (e.TurningItems_FaceUp.includes(t)) return i();
                    e.TurningItems_FaceUp.push(t),
                      (e.TurningItems_FaceDown = e.TurningItems_FaceDown.filter(
                        function (e) {
                          return e != t;
                        }
                      ));
                    ...
                    e.TurningItems_FaceDown.push(t),
                      (e.TurningItems_FaceUp = e.TurningItems_FaceUp.filter(
                        function (e) {
                          return e != t;
                        }
                      )),
          ...
          var e = (H.ResizeObserver = {
            ...
            onResize: function (t) {
              !_.LayingOut &&
                ...
                (e.Resizing ||
                  ((e.Resizing = !0),
                  (e.TargetPageAfterResizing = H.PageObserver.Current.List[0]
                ...
                (e.Timer_onResizeEnd = setTimeout(
                  function () {
                    _.updateOrientation();
                    var n =
                      e.TargetPageAfterResizing ||
                      (H.PageObserver.Current.List[0]
                        ? H.PageObserver.Current.List[0].Page
                        : null);
                    _.layOutBook({
                      ...
                      Destination: n
                        ? {
                            ...
                            PageProgressInItem:
                              n.IndexInItem / n.Item.Pages.length,
                          }
                        : null,
                    }).then(function () {
        ...
        create: function () {
          var e = (H.TouchObserver = {
              ...
              setElementHoverActions: function (e) {
                return (
                  W.add(e, "bibi:hovered", function (t) {
                    return (
                      e.Hover ||
                        (e.isAvailable && !e.isAvailable(t)) ||
                        ((e.Hover = !0),
              ...
              observeElementTap: function (e) {
                ...
                if (!e.BibiTapObserver) {
                  var n = { D2U: 300, U2D: 300 };
                  (e.BibiTapObserver = {
                    care: t.PreventDefault
                      ? t.StopPropagation
                        ? function (e) {
                    ...
                    onPointerDown: function (e) {
                      if (
                        ("number" == typeof e.buttons && 1 !== e.buttons) ||
                        e.ctrlKey
                      )
                        return !0;
                      this.care(e),
                    ...
                    onPointerUp: function (t) {
                      ...
                      if ((this.care(t), this.Touching)) {
                        ...
                        if (r - this.Touching.Time < n.D2U) {
                          ...
                          if (
                            Math.abs(o.X - this.Touching.Coord.X) < 3 &&
                            Math.abs(o.Y - this.Touching.Coord.Y) < 3
                          ) {
                            var a = 0,
                              s = {
                                Time: r,
                            ...
                            this.Floating
                              ...
                              (this.Timer_forgetFloating = setTimeout(
                                function () {
                                  delete i.Floating;
                                },
                                n.U2D
                  ...
                  switch (e.Type) {
                    case "toggle":
                      return function (t) {
                        ...
                        H.setUIState(
                          e,
                          "default" == e.UIState ? "active" : "default"
                        );
                      };
                    case "radio":
                      return function (t) {
            ...
            t = function (e) {
              ...
              if (e.Target.ownerDocument) {
                ...
                if (
                  H.Slider.ownerDocument &&
                  (e.Target == H.Slider || H.Slider.contains(e.Target))
                )
                  return !1;
              }
              return !0;
          ...
          W.bind("bibi:readied", function () {
            ...
            W.add("bibi:tapped", function (e) {
              ...
              return (
                !!t(n) &&
                ("center" == n.Division.X && "middle" == n.Division.Y
                  ? W.dispatch("bibi:tapped-center", e)
                  : W.dispatch("bibi:tapped-not-center", e))
              );
            }),
            W.add("bibi:doubletapped", function (e) {
              ...
              return (
                !!t(n) &&
                ("center" == n.Division.X && "middle" == n.Division.Y
                  ? W.dispatch("bibi:doubletapped-center", e)
                  : W.dispatch("bibi:doubletapped-not-center", e))
              );
            }),
        ...
        create: function () {
          var e = (H.FlickObserver = {
            ...
            getDegree: function (e) {
              return (t = (180 * Math.atan2(-1 * e.Y, e.X)) / Math.PI) < 0
                ? t + 360
                : t;
              var t;
            },
            ...
            onTouchMove: function (t) {
              if ((H.ScrollObserver.breakCurrentScrolling(), e.StartedAt)) {
                if (!e.Moving) {
                  ...
                  if (
                    U.TouchOS ||
                    ("mousemove" != t.type && "mouse" != t.pointerType)
                  ) {
                ...
                var i = U.getBibiEventCoord(t),
                  r = { X: i.X - e.StartedAt.X, Y: i.Y - e.StartedAt.Y };
                if (++e.Moving <= 3) {
                  var o = e.getDegree(r);
                  e.StartedAt.LaunchingAxis =
                    315 <= o || o <= 45 || (135 <= o && o <= 225)
                      ? "X"
                      : (45 < o && o < 135) || (225 < o && o < 315)
                      ? "Y"
                      : "";
                }
                if (e.StartedAt.LaunchingAxis == z.A_AXIS_B);
                  ...
                  if ("paged" != F.RVM && "touchmove" == t.type)
                    return e.cancel();
                  F["content-draggable"]["paged" == F.RVM ? 0 : 1] &&
                    H.isScrollable() &&
                    (_.Main["scroll" + z.L_OOBL_L] =
                      e.StartedAt["Scroll" + z.L_OOBL_L] + -1 * r[z.L_AXIS_L]);
                }
                if (
                  (t.preventDefault(),
                  e.StartedAt.Item &&
                    (e.StartedAt.Item.HTML.classList.add("bibi-flick-hot"),
                    e.StartedAt.Item.contentWindow.getSelection().empty()),
                  (e.LastEvent = t),
                  i[z.A_AXIS_L] <= 0 ||
                    i[z.A_AXIS_L] >= _.Stage[z.A_SIZE_L] ||
                    i[z.A_AXIS_B] <= 0 ||
                    i[z.A_AXIS_B] >= _.Stage[z.A_SIZE_B])
                )
                  return e.onTouchEnd(t, { Swipe: !0 });
              }
            },
            onTouchEnd: function (t, n) {
              ...
              if (e.StartedAt) {
                var o = U.getBibiEventCoord(t),
                  a = { X: o.X - e.StartedAt.X, Y: o.Y - e.StartedAt.Y };
                e.StartedAt.Item &&
                  e.StartedAt.Item.HTML.classList.remove("bibi-flick-hot"),
                  H.Loupe.Transforming ||
                    (e.StartedAt.LaunchingAxis == z.A_AXIS_B &&
                      Math.abs(a[z.A_AXIS_B] / 100) >= 1 &&
                      (i = e.getOrthogonalTouchMoveFunction()),
                    !i &&
                      (Math.abs(a.X) >= 3 || Math.abs(a.Y) >= 3) &&
                      (t.preventDefault(),
                      (r.Speed =
                        Math.sqrt(Math.pow(a.X, 2) + Math.pow(a.Y, 2)) /
                        (t.timeStamp - e.StartedAt.TimeStamp)),
                      (r.Deg = e.getDegree(a)),
                      U.getViewportZooming() <= 1 &&
                      t.timeStamp - e.StartedAt.TimeStamp <= 300
                        ? ((r.OriginList = e.StartedAt.OriginList),
                          (i = n && n.Swipe ? e.onSwipe : e.onFlick))
                        : H.isScrollable() && (i = e.onPanRelease))),
                  delete e.StartedAt;
              }
            ...
            onFlick: function (t, n) {
              ...
              if (o) {
                if (
                  ...
                  var a =
                    o > 0
                      ? n.OriginList.slice(-1)[0].Page.Index
                      : n.OriginList[0].Page.Index;
                  return _.focusOn({
                    Destination: {
                    ...
                    Duration:
                      H.isScrollable() &&
                      ("paged" != F.RVM || F["content-draggable"][0])
                        ? 123
                        : 0,
                  });
                }
                return _.scrollBy({
                  Distance:
                    ...
                    (n.Speed
                      ? (333 *
                          sML.limitMinMax(
                            0.08 * Math.round(100 * n.Speed),
                            0.33,
                            10
                          )) /
                        ("ttb" == F.SLD ? _.Stage.Height : _.Stage.Width)
                      : 1),
                  Duration: 1234,
                  Cancelable: !0,
                  ease: function (e) {
            ...
            onPanRelease: function (e, t) {
              ...
              var n = t.Deg,
                i =
                  270 < n || n < 90 ? "left" : 90 < n && n < 270 ? "right" : "",
                r = z.d2d(i),
                o = H.PageObserver.updateCurrent().List;
              return _.focusOn({
                Destination: { Page: r >= 0 ? o.slice(-1)[0].Page : o[0].Page },
                Duration:
                  H.isScrollable() && F["content-draggable"][0] ? 123 : 0,
              });
            },
            ...
            activateElement: function (t) {
              ...
              t.ownerDocument.documentElement.classList.add(n + "flick-active"),
                H.isScrollable() &&
                  t.ownerDocument.documentElement.classList.add(
                    n + "flick-scrollable"
                  );
            },
            deactivateElement: function (t) {
              ...
              var n = e.getCNPf(t);
              t.ownerDocument.documentElement.classList.remove(
                n + "flick-active"
              ),
                t.ownerDocument.documentElement.classList.remove(
                  n + "flick-scrollable"
        ...
        create: function () {
          var e = (H.WheelObserver = {
            ...
            onWheel: function (t) {
              ...
              if (
                ...
                i.Distance != r[o - 1].Distance
                  ? ((i.Accel = 1),
                    (i.Wheeled =
                      o >= 3 &&
                      r[o - 2].Distance != i.Distance &&
                      r[o - 3].Distance != i.Distance
                        ? "reverse"
                        : ""))
                  : i.Delta > r[o - 1].Delta
                  ? ((i.Accel = 1),
              ...
              var a =
                n != z.A_AXIS_L
                  ? H.orthogonal("wheelings")
                  : "paged" == F.RVM
                  ? "move"
                  : e.OverlaidUIs.filter(function (e) {
            ...
            switchAxis: function () {
              !H.AxisSwitcher ||
                Math.abs(e.Progress) < 1 ||
                (e.heat(), H.AxisSwitcher.switchAxis());
            },
            OverlaidUIs: [],
          });
          document.addEventListener(
            ...
            W.add("bibi:loaded-item", function (e) {
              return e.contentDocument.addEventListener(
                "wheel",
                function (e) {
                  return W.dispatch("bibi:is-wheeling", e);
                },
          ...
          var e = (H.PinchObserver = {
            ...
            getEventCoords: function (e) {
              var t = e.touches[0],
                ...
                r = t.screenY;
              return {
                Center: { X: (i + n.screenX) / 2, Y: (r + n.screenY) / 2 },
                Distance: Math.sqrt(
                  Math.pow(n.screenX - t.screenX, 2) +
                    Math.pow(n.screenY - t.screenY, 2)
                ),
              };
            },
            onTouchStart: function (t) {
          ...
          if (F["use-keys"]) {
            var e = (H.KeyObserver = {
              ...
              initializeKeyParameters: function () {
                var t = { End: "foot", Home: "head" };
                for (var n in t)
                  t[n.toUpperCase()] =
                    "head" == t[n] ? "foot" : "foot" == t[n] ? "head" : t[n];
                e.KeyParameters = t;
              },
              ...
              onEvent: function (t) {
                return (
                  !!k.Opened &&
                  ((t.BibiKeyName = e.getBibiKeyName(t)),
                  (t.BibiModifierKeys = []),
              ...
              onKeyDown: function (t) {
                ...
                t.BibiKeyName &&
                  (e.ActiveKeys[t.BibiKeyName]
                    ? W.dispatch("bibi:is-holding-key", t)
                    : (e.ActiveKeys[t.BibiKeyName] = Date.now())),
                  W.dispatch("bibi:downed-key", t);
              },
              onKeyUp: function (t) {
                if (!e.onEvent(t)) return !1;
                e.ActiveKeys[t.BibiKeyName] &&
                  Date.now() - e.ActiveKeys[t.BibiKeyName] < 300 &&
                  W.dispatch("bibi:touched-key", t),
                  t.BibiKeyName &&
                    e.ActiveKeys[t.BibiKeyName] &&
                    delete e.ActiveKeys[t.BibiKeyName],
              ...
              observe: function (t) {
                ["keydown", "keyup", "keypress"].forEach(function (n) {
                  return t.addEventListener(
                    n,
                    e["onKey" + sML.capitalise(n.replace("key", ""))],
                    !1
                  );
                });
              },
              onKeyTouch: function (t) {
                ...
                var n =
                  e.KeyParameters[
                    t.shiftKey ? t.BibiKeyName.toUpperCase() : t.BibiKeyName
                  ];
                if (!n) return !1;
                switch ((t.preventDefault(), I(n))) {
                  case "number":
                    H.Flipper.isAbleToFlip(n) &&
                      (H.Arrows && W.dispatch(H.Arrows[n], "bibi:tapped", t),
                      H.Flipper.flip(n));
                    break;
                  case "string":
                    switch (n) {
                      case "head":
                      case "foot":
                        return _.focusOn({ Destination: n, Duration: 0 });
                      case "utilities":
                        return H.Utilities.toggleGracefuly();
                      case "switch":
            ...
            e.updateKeyCodes(["keydown", "keyup", "keypress"], { 32: "Space" }),
      ...
      (H.EdgeObserver = {
        create: function () {
          ...
          W.add("bibi:opened", function () {
            W.add(
              ["bibi:tapped-not-center", "bibi:doubletapped-not-center"],
              function (e) {
                if (H.isPointerStealth()) return !1;
                ...
                if (r)
                  H.Arrows &&
                    H.Arrows.areAvailable(t) &&
                    W.dispatch(H.Arrows[r], "bibi:tapped", e),
                  ...
                  if (H.Arrows.areAvailable(n)) {
                    ...
                    if (o && H.Flipper.isAbleToFlip(o)) {
                      ...
                      return void (
                        e.HoveringHTML != s &&
                        (e.HoveringHTML &&
                          e.HoveringHTML.removeAttribute("data-bibi-cursor"),
                        (e.HoveringHTML = s).setAttribute(
                          "data-bibi-cursor",
                          i
                        ))
                      );
            ...
            U.TouchOS ||
              W.add("bibi:loaded-item", function (e) {
                return sML.forEach(e.Body.querySelectorAll("img"))(function (
                  e
                ) {
                  return e.addEventListener(W.pointerdown, U.preventDefault);
                });
      ...
      (H.Notifier = {
        create: function () {
          var e = (H.Notifier = U.Body.appendChild(
            sML.create("div", {
              id: "bibi-notifier",
              show: function (t, n) {
                clearTimeout(e.Timer_hide),
                  ...
                  k.Opened &&
                    !n &&
                    e.addEventListener(
                      U.TouchOS ? W.pointerdown : W.pointerover,
                      e.hide
                    );
              },
              hide: function () {
      ...
      (H.Veil = {
        create: function () {
          var e = (H.Veil = H.setToggleAction(
            U.Body.appendChild(sML.create("div", { id: "bibi-veil" })),
            {
              onopened: function () {
                return (
                  U.HTML.classList.add("veil-opened"),
          ...
          ["touchstart", "pointerdown", "mousedown", "click"].forEach(function (
            t
          ) {
          ...
          var t = (U.TouchOS ? "Tap" : "Click") + " to Open",
            n = (e.PlayButton = e.appendChild(
              sML.create("p", {
                ...
                hide: function () {
                  return sML
                    .style(n, { opacity: 0, cursor: "default" })
                    .then(function (t) {
          ...
          W.add("bibi:played", function () {
            ...
            (e.byebye = function () {
              ...
              return (
                (e.innerHTML = ""),
                (e.ByeBye = e.appendChild(
                  sML.create("p", { id: "bibi-veil-byebye" })
                )),
                ["en", "ja"].forEach(function (n) {
                  return (e.ByeBye.innerHTML += '<span lang="'
                    .concat(n, '">')
                    .concat(t[n], "</span>"));
                }),
                U.HTML.classList.remove("welcome"),
            ...
            (e.Cover = e.appendChild(
              sML.create("div", { id: "bibi-veil-cover" })
            )),
            (e.Cover.Info = e.Cover.appendChild(
      ...
      (H.Catcher = {
        create: function () {
          if (!F["book-data"] && !F.book && F["accept-local-file"]) {
            var e = (H.Catcher = U.Body.appendChild(
              sML.create("div", { id: "bibi-catcher" })
            ));
            if (
                ...
                H.distillLabels.distillLanguage({
                  default: [
                    ...
                    "<p><span>Please ".concat(
                      U.TouchOS
                        ? "Tap Screen"
                        : "Drag & Drop It Here. <br />Or Click Screen",
                      " and Choose It.</span></p>"
                    ),
              ...
              (e.title = e
                ...
                .replace(/<[^>]+>/g, "")
                .trim()),
              (e.Input = e.appendChild(sML.create("input", { type: "file" }))),
              !F["extract-if-necessary"].includes("*") &&
                F["extract-if-necessary"].length)
            ) {
              var t = [];
              F["extract-if-necessary"].includes(".epub") &&
                t.push("application/epub+zip"),
                F["extract-if-necessary"].includes(".zip") &&
                  (t.push("application/zip"),
            ...
            e.Input.addEventListener("change", function (e) {
              ...
              x.getBookData.resolve({ BookData: t });
            }),
      ...
      (H.Menu = {
        create: function () {
          ...
          var e = (H.Menu = U.Body.appendChild(
            sML.create("div", { id: "bibi-menu" }, H.Menu)
          ));
          delete e.create,
              ...
              W.add("bibi:opened", function () {
                W.add("bibi:moved-pointer", function (t) {
                  ...
                  clearTimeout(e.Timer_close),
                    "top" == n.Division.Y
                      ? W.dispatch(e, "bibi:hovered", t)
                      : e.Hover &&
                        (e.Timer_close = setTimeout(function () {
                          return W.dispatch(e, "bibi:unhovered", t);
                        }, 123));
                });
              }),
            (e.L = e.appendChild(sML.create("div", { id: "bibi-menu-l" }))),
            (e.R = e.appendChild(sML.create("div", { id: "bibi-menu-r" }))),
            [e.L, e.R].forEach(function (e) {
              (e.ButtonGroups = []),
                (e.addButtonGroup = function (e) {
                  var t = H.createButtonGroup(e);
                  return t
                    ? (this.ButtonGroups.push(t), this.appendChild(t))
                    : null;
                });
            });
          var t =
          ...
          sML.appendCSSRule(
            t + n,
            "width: calc(100% - " + U.Scrollbars.Width + "px);"
          ),
            sML.appendCSSRule(
              [t + ".panel-opened" + n, t + ".subpanel-opened" + n].join(", "),
              "padding-right: " + U.Scrollbars.Width + "px;"
            ),
      ...
      (H.Menu.Config = {
        create: function () {
          var e = H.Menu,
            t = [];
          if (
            (F["fix-reader-view-mode"] || t.push("ViewModeSection"),
            U.Embedded && t.push("NewWindowButton"),
            U.FullscreenTarget && !U.TouchOS && t.push("FullscreenButton"),
            F["website-href"] &&
              /^https?:\/\/[^\/]+/.test(F["website-href"]) &&
              F["website-name-in-menu"] &&
              t.push("WebsiteLink"),
            F["remove-bibi-website-link"] || t.push("BibiWebsiteLink"),
            t.length)
          ) {
            var n = (e.Config = sML.applyRtL(
              H.createSubpanel({ id: "bibi-subpanel_config" }),
              e.Config
            ));
            delete n.create;
            n.bindOpener(
              e.R.addButtonGroup({ Sticky: !0 }).addButton({
                Type: "toggle",
                Labels: {
                  default: { default: "تغییر حالت نمایش", ja: "設定を変更" },
                  active: {
            ...
            t.includes("ViewModeSection")
              ? n.ViewModeSection.create()
              : delete n.ViewModeSection,
              t.includes("NewWindowButton") || t.includes("FullscreenButton")
                ? n.WindowSection.create(t)
                : delete n.WindowSection,
              t.includes("WebsiteLink") || t.includes("BibiWebsiteLink")
                ? n.LinkageSection.create(t)
                : delete n.LinkageSection,
        ...
        create: function () {
          var e,
            ...
            r = (n.ViewModeSection = n.addSection({
              Labels: { default: { default: "حالت صفحه", ja: "閲覧モード" } },
              ButtonGroups: [
                {
                  ButtonType: "radio",
                  Buttons: [
                    ...
                    },
                    {
                      ...
                      Labels: {
                        default: {
                          default:
                            '<span class="non-visual-in-label">⇄ </span>افقی',
                          ja:
                    ...
                    },
                    {
                      ...
                      Labels: {
                        default: {
                          default:
                            '<span class="non-visual-in-label">⇅ </span>عمودی',
                          ja:
                  ...
                  Buttons: [
                    {
                      ...
                      Labels: {
                        default: {
                          default:
                            "Full Width for Each Page <small>(in Scrolling Mode)</small>",
                      ...
                      action: function () {
                        ...
                        F.update({ "full-breadth-layout-in-scroll": e }),
                          e
                            ? U.HTML.classList.add("book-full-breadth")
                            : U.HTML.classList.remove("book-full-breadth"),
                          ("horizontal" != F.RVM && "vertical" != F.RVM) ||
                            _.changeView({ Mode: F.RVM, Force: !0 }),
                          F["keep-settings"] &&
                            U.Biscuits &&
                            U.Biscuits.memorize("Book", {
        ...
        create: function (e) {
          ...
          e.includes("FullscreenButton") &&
            (n.push({
              ...
              action: function () {
                U.Fullscreen
                  ? U.FullscreenTarget.ownerDocument.exitFullscreen()
                  : U.FullscreenTarget.requestFullscreen(),
                  t.close();
              },
            }),
            U.FullscreenTarget.ownerDocument.addEventListener(
              "fullscreenchange",
              function () {
                U.FullscreenButton ||
                  (U.FullscreenButton = document.getElementById(
                    "bibi-button-toggle-fullscreen"
                  )),
                  this.fullscreenElement == U.FullscreenTarget
                    ? ((U.Fullscreen = !0),
                      U.HTML.classList.add("fullscreen"),
                      H.setUIState(U.FullscreenButton, "active"))
                    : U.Fullscreen &&
                      ((U.Fullscreen = !1),
          ...
          n.length) &&
            (t.WindowSection = t.addSection({
              Labels: {
                default: { default: "کنترل صفحه", ja: "ウィンドウ制御" },
              },
      ...
      (H.Menu.Config.LinkageSection = {
        create: function (e) {
          var t = H.Menu.Config,
            n = [];
          (e.includes("WebsiteLink") &&
            n.push({
              Type: "link",
              Labels: {
                default: {
                  default: F["website-name-in-menu"]
                    .replace(/&/gi, "&amp;")
                    .replace(/</gi, "&lt;")
                    .replace(/>/gi, "&gt;"),
                },
      ...
      (H.Panel = {
        create: function () {
          var e = (H.Panel = U.Body.appendChild(
          ...
          H.setToggleAction(e, {
            ...
            H.setFeedback(e, { StopPropagation: !0 }),
            W.add(e, "bibi:tapped", function () {
              return W.dispatch("bibi:commands:toggle-panel");
            }),
            (e.BookInfo = e.appendChild(
              sML.create("div", { id: "bibi-panel-bookinfo" })
            )),
            (e.BookInfo.Cover = e.BookInfo.appendChild(
              sML.create("div", { id: "bibi-panel-bookinfo-cover" })
            )),
            (e.BookInfo.Cover.Info = e.BookInfo.Cover.appendChild(
              sML.create("p", { id: "bibi-panel-bookinfo-cover-info" })
            ));
          var t = (e.Opener = H.Menu.L.addButtonGroup({ Sticky: !0 }).addButton(
            {
              Type: "toggle",
              Labels: {
                default: { default: "فهرست", ja: "目次を開く" },
                active: { default: "بستن", ja: "目次を閉じる" },
              },
              Help: !0,
          ...
          W.add("bibi:opened-panel", function () {
            ...
            "panel" == F["on-doubletap"] &&
              W.add("bibi:doubletapped", function () {
                return e.toggle();
              }),
            "panel" == F["on-tripletap"] &&
              W.add("bibi:tripletapped", function () {
                return e.toggle();
              }),
      ...
      (H.Help = {
        create: function () {
          var e = (H.Help = U.Body.appendChild(
            sML.create("div", { id: "bibi-help" })
          ));
          (e.Message = e.appendChild(
            sML.create("p", { className: "hidden", id: "bibi-help-message" })
          )),
            (e.show = function (t) {
      ...
      (H.PoweredBy = {
        create: function () {
          H.PoweredBy = U.Body.appendChild(
            sML.create("div", {
              id: "bibi-poweredby",
              innerHTML: '<p><a href="'.concat(
                x.href,
                '" target="_blank" title="Bibi | Official Website">Bibi</a></p>'
              ),
            })
          );
        },
      ...
      (H.FontSizeChanger = {
        create: function () {
          ...
          if (
            (("number" != typeof F["font-size-scale-per-step"] ||
              F["font-size-scale-per-step"] <= 1) &&
              (F["font-size-scale-per-step"] = 1.25),
            F["use-font-size-changer"] && F["keep-settings"] && U.Biscuits)
          ) {
            var t = U.Biscuits.remember("Bibi");
            t &&
              t.FontSize &&
              null != t.FontSize.Step &&
              (e.Step = 1 * t.FontSize.Step);
          }
          if (
            (("number" != typeof e.Step || e.Step < -2 || 2 < e.Step) &&
              (e.Step = 0),
            W.bind("bibi:postprocessed-item", function (t) {
              if ("pre-paginated" == t["rendition:layout"]) return !1;
              if (
                ((t.changeFontSize = function (e) {
                  t.FontSizeStyleRule &&
                    sML.deleteCSSRule(t.contentDocument, t.FontSizeStyleRule),
                    (t.FontSizeStyleRule = sML.appendCSSRule(
                      t.contentDocument,
                      "html",
                ...
                (t.changeFontSizeStep = function (e) {
                  return t.changeFontSize(
                    t.FontSize.Base * Math.pow(F["font-size-scale-per-step"], e)
                  );
                }),
                (t.FontSize = {
                  Default:
                    1 *
                    getComputedStyle(t.HTML).fontSize.replace(/[^\d]*$/, ""),
                }),
                (t.FontSize.Base = t.FontSize.Default),
                t.Source.Preprocessed && (sML.UA.Chrome || sML.UA.Trident)
                  ? sML.forEach(t.HTML.querySelectorAll("body, body *"))(
                      function (e) {
                        return (e.style.fontSize =
                          parseInt(getComputedStyle(e).fontSize) /
                            t.FontSize.Base +
                          "rem");
                      }
                    )
                  : U.editCSSRules(t.contentDocument, function (e) {
                      if (e && e.selectorText && !/^@/.test(e.selectorText)) {
                        try {
                          if (
                            t.contentDocument.querySelector(e.selectorText) ==
                            t.HTML
                          )
                            return;
                        } catch (e) {}
                        ...
                        n.pt.test(e.cssText) &&
                          (e.style.fontSize =
                            (e.cssText.match(n.pt)[1] * (96 / 72)) /
                              t.FontSize.Base +
                            "rem"),
                          n.px.test(e.cssText) &&
                            (e.style.fontSize =
                              e.cssText.match(n.px)[1] / t.FontSize.Base +
                              "rem");
                      }
                    }),
                "number" == typeof F["base-font-size"] &&
                  F["base-font-size"] > 0)
              ) {
                var n = 0,
                  i = {};
                sML.forEach(t.Body.querySelectorAll("p, p *"))(function (e) {
                  if (e.innerText.replace(/\s/g, "")) {
                    var t =
                      Math.round(
                        100 *
                          getComputedStyle(e).fontSize.replace(/[^\d]*$/, "")
                      ) / 100;
                    i[t] || (i[t] = []), i[t].push(e);
                  }
                });
                var r = 0;
                for (var o in i)
                  i[o].length > r && ((r = i[o].length), (n = o));
                n &&
                  (t.FontSize.Base =
                    t.FontSize.Base * (F["base-font-size"] / n)),
            ...
            (e.changeFontSizeStep = function (t, n) {
              "pre-paginated" != F.BRL &&
                ...
                F["use-font-size-changer"] &&
                  F["keep-settings"] &&
                  U.Biscuits &&
                  U.Biscuits.memorize("Book", { FontSize: { Step: t } }),
                setTimeout(function () {
                  _.layOutBook({
                    before: function () {
                    ...
                    W.dispatch("bibi:changed-font-size", { Step: t }),
                ...
                Buttons: [
                  {
                    Labels: {
                      default: {
                        default:
                          '<span class="non-visual-in-label">Font Size:</span> خیلی بزرگ',
                        ja:
                  ...
                  },
                  {
                    Labels: {
                      default: {
                        default:
                          '<span class="non-visual-in-label">Font Size:</span> بزرگ',
                        ja:
                  ...
                  },
                  {
                    Labels: {
                      default: {
                        default:
                          '<span class="non-visual-in-label">Font Size:</span> متوسط <small>دیفالت</small>',
                        ja:
                  ...
                  },
                  {
                    Labels: {
                      default: {
                        default:
                          '<span class="non-visual-in-label">Font Size:</span> کوچک',
                        ja:
                  ...
                  },
                  {
                    Labels: {
                      default: {
                        default:
                          '<span class="non-visual-in-label">Font Size:</span> خیلی کوچک',
                        ja:
      ...
      (H.Loupe = {
        create: function () {
          F["loupe-max-scale"] <= 1 && (F["loupe-max-scale"] = 4),
            ...
            F["loupe-scale-per-step"] > F["loupe-max-scale"] &&
              (F["loupe-scale-per-step"] = F["loupe-max-scale"]);
          var e = (H.Loupe = {
            CurrentTransformation: { Scale: 1, TranslateX: 0, TranslateY: 0 },
            defineZoomOutPropertiesForUtilities: function () {
              var t =
                  F["use-menubar"] && F["use-full-height"] ? H.Menu.Height : 0,
                n = "vertical" == F.ARA ? H.Slider.Size : 0,
                i = "horizontal" == F.ARA ? H.Slider.Size : 0,
                r = {};
              "horizontal" == F.ARA
                ? ((r.Scale =
                    (_.Main.offsetHeight - (t + i)) /
                    (_.Main.offsetHeight -
                      (F.ARA != F.SLA ||
                      ("paged" == F.RVM && !H.Slider.ownerDocument)
                        ? 0
                        : U.Scrollbars.Height))),
                  (r.TranslateX = 0))
                : ((r.Scale = Math.min(
                    (_.Main.offsetWidth - n) /
                      (_.Main.offsetWidth - U.Scrollbars.Width),
                    (_.Main.offsetHeight - t) / _.Main.offsetHeight
                  )),
                  (r.TranslateX = (_.Main.offsetWidth * (1 - r.Scale)) / -2)),
                (r.TranslateY = t - (_.Main.offsetHeight * (1 - r.Scale)) / 2);
              var o =
                  U.Body["offset" + z.A_SIZE_L] / r.Scale -
                  _.Main["offset" + z.A_SIZE_L],
                a = {};
              (a[z.A_BASE_B] =
                o / 2 +
                (F["use-full-height"] || "vertical" != F.ARA
                  ? 0
                  : H.Menu.Height)),
                (a[z.A_BASE_A] = o / 2);
              var s = {};
              F.ARA == F.SLA &&
                (s["horizontal" == F.ARA ? "Right" : "Bottom"] = o / 2),
            ...
            getNormalizedTransformation: function (t) {
              ...
              return (
                t &&
                  ("number" == typeof t.Scale && (n.Scale = t.Scale),
                  "number" == typeof t.TranslateX &&
                    (n.TranslateX = t.TranslateX),
                  "number" == typeof t.TranslateY &&
            ...
            transform: function (t) {
              ...
              return new Promise(function (i, r) {
                ...
                if (
                  ...
                  var o = window.innerWidth * (0.5 * (t.Scale - 1)),
                    a = window.innerHeight * (0.5 * (t.Scale - 1));
                  (t.TranslateX = sML.limitMinMax(
                    ...
                    -1 * o -
                      ("vertical" != F.RVM
                        ...
                        ? H.Slider.Size - U.Scrollbars.Width
                        : 0) +
                      U.Scrollbars.Width,
                    o
                  )),
                    (t.TranslateY = sML.limitMinMax(
                      t.TranslateY,
                      -1 * a -
                        ("vertical" == F.RVM
                          ? 0
                          : "active" == H.Slider.UIState
                          ? H.Slider.Size - U.Scrollbars.Height
                          : 0) +
                        U.Scrollbars.Height,
                      a + ("active" == H.Menu.UIState ? H.Menu.Height : 0)
                    ));
                }
                e.CurrentTransformation = t;
                var s,
                  c = e.getActualTransformation(t);
                sML.style(_.Main, {
                  transform:
                    ((s = []),
                    c.TranslateX && c.TranslateY
                      ...
                      : c.TranslateX
                      ? s.push("translateX(" + c.TranslateX + "px)")
                      : c.TranslateY &&
                        s.push("translateY(" + c.TranslateY + "px)"),
                    1 != c.Scale && s.push("scale(" + c.Scale + ")"),
                    s.length ? s.join(" ") : ""),
                }),
                  (e.Timer_onTransformEnd = setTimeout(function () {
                    1 == e.CurrentTransformation.Scale
                      ? (U.HTML.classList.remove("zoomed-in"),
                        U.HTML.classList.remove("zoomed-out"))
                      : e.CurrentTransformation.Scale < 1
                      ? (U.HTML.classList.remove("zoomed-in"),
                        U.HTML.classList.add("zoomed-out"))
                      : (U.HTML.classList.add("zoomed-in"),
                        U.HTML.classList.remove("zoomed-out")),
            ...
            scale: function (t) {
              ...
              (t =
                "number" == typeof t
                  ? sML.limitMinMax(t, 1, F["loupe-max-scale"])
                  : 1),
              ...
              if (t < 1)
                ...
                n.Center ||
                  ...
                  (r =
                    i.TranslateX +
                    (n.Center.X - window.innerWidth / 2 - i.TranslateX) *
                      (1 - t / i.Scale)),
                  (o =
                    i.TranslateY +
                    (n.Center.Y - window.innerHeight / 2 - i.TranslateY) *
                      (1 - t / i.Scale));
              }
              return e.transform({ Scale: t, TranslateX: r, TranslateY: o });
            },
            BookStretchingEach: 0,
            transformToDefault: function () {
              return e.transform({ Scale: 1, TranslateX: 0, TranslateY: 0 });
            },
            transformForUtilities: function (t) {
              ...
              if (t) {
                ...
                e.BookStretchingEach =
                  e.ZoomOutPropertiesForUtilities.Stretch / 2;
              } else {
                if (!e.IsZoomedOutForUtilities) return Promise.resolve();
            ...
            checkAndGetBibiEventForTaps: function (t) {
              ...
              if (n.Target.tagName) {
                ...
                if (
                  "horizontal" == F.RVM &&
                  n.Coord.Y > window.innerHeight - U.Scrollbars.Height
                )
                  return null;
              }
              return n;
            ...
            onTap: function (t, n) {
              if (
                !(
                  1 != n ||
                  (H.KeyObserver.ActiveKeys && H.KeyObserver.ActiveKeys.Space)
                )
              )
                return Promise.resolve();
              ...
              t.preventDefault();
              try {
                t.target.ownerDocument.body.Item.contentWindow
                  .getSelection()
                  .empty();
              } catch (e) {}
              return e.CurrentTransformation.Scale >= F["loupe-max-scale"] &&
                !t.shiftKey
                ? e.scale(1)
                : e.scale(
                    e.CurrentTransformation.Scale *
                      (t.shiftKey
                        ? 1 / F["loupe-scale-per-step"]
                        : F["loupe-scale-per-step"]),
                    { Center: i.Coord }
                  );
            },
            ...
            onPointerMove: function (t) {
              ...
              var n = U.getBibiEvent(t);
              clearTimeout(e.Timer_TransitionRestore),
                sML.style(_.Main, { transition: "none" }, { cursor: "move" }),
                e.transform({
                  Scale: e.CurrentTransformation.Scale,
                  TranslateX:
                    e.PointerDownTransformation.TranslateX +
                    (n.Coord.X - e.PointerDownCoord.X),
                  TranslateY:
                    e.PointerDownTransformation.TranslateY +
                    (n.Coord.Y - e.PointerDownCoord.Y),
                }),
                (e.Timer_TransitionRestore = setTimeout(function () {
                  return sML.style(_.Main, { transition: "" }, { cursor: "" });
                }, 234));
            },
          });
          if (
            (H.isPointerStealth.addChecker(function () {
              return (
                !!e.Dragging ||
                !(!H.KeyObserver.ActiveKeys || !H.KeyObserver.ActiveKeys.Space)
              );
            ...
            "zoom" == F["on-doubletap"] &&
              W.add("bibi:doubletapped", function (t) {
                return e.onTap(t, 2);
              }),
            "zoom" == F["on-tripletap"] &&
              W.add("bibi:tripletapped", function (t) {
                return e.onTap(t, 3);
              }),
            ...
            F["zoom-out-for-utilities"] &&
              (W.add("bibi:opens-utilities", function () {
              ...
              Buttons: [
                {
                  ...
                  action: function () {
                    return e.scale(
                      e.CurrentTransformation.Scale * F["loupe-scale-per-step"]
                    );
                  },
                  updateState: function (t) {
                    H.setUIState(
                      ...
                      "string" == typeof t
                        ? t
                        : e.CurrentTransformation.Scale >= F["loupe-max-scale"]
                        ? "disabled"
                        : "default"
                    );
                  },
      ...
      (H.Nombre = {
        create: function () {
          if (F["use-nombre"]) {
            var e = (H.Nombre = U.Body.appendChild(
              sML.create("div", {
                id: "bibi-nombre",
                ...
                progress: function (t) {
                  if (
                    ...
                    (e.Current.innerHTML =
                      ...
                      e.show(),
                      "active" != H.Slider.UIState &&
                        (e.Timer_autohide = setTimeout(e.hide, 1234));

                    totalpage = _.Pages.length;
                  }
                },
              })
            ));
            (e.Current = e.appendChild(
              sML.create("span", { className: "bibi-nombre-current" })
            )),
              (e.Delimiter = e.appendChild(
                sML.create("span", { className: "bibi-nombre-delimiter" })
              )),
              (e.Total = e.appendChild(
                sML.create("span", { className: "bibi-nombre-total" })
              )),
              (e.Percent = e.appendChild(
                sML.create("span", { className: "bibi-nombre-percent" })
              )),
              W.add("bibi:opened", function () {
              ...
              sML.appendCSSRule(
                ...
                "bottom: " + (U.Scrollbars.Height + 2) + "px;"
              ),
              sML.appendCSSRule(
              ...
              sML.appendCSSRule(
                ...
                "right: " + (U.Scrollbars.Height + 2) + "px;"
              ),
      ...
      (H.History = {
        ...
        add: function () {
          ...
          var t = _.hatchPage(H.History.List.slice(-1)[0]),
            n = e.Destination
              ? _.hatchPage(e.Destination)
              : (H.PageObserver.updateCurrent(),
                H.PageObserver.Current.List[0].Page);
          if (
            n != t &&
            (e.SumUp &&
              H.History.List.slice(-1)[0].UI == e.UI &&
              H.History.List.pop(),
            H.History.List.push({
              UI: e.UI,
              IIPP: H.PageObserver.getIIPP({ Page: n }),
            }),
        ...
        back: function () {
          ...
          return H.History.update(), _.focusOn({ Destination: e, Duration: 0 });
        },
      }),
      (H.Slider = {
        create: function () {
          if (!F["use-slider"]) return !1;
          var e = (H.Slider = U.Body.appendChild(
            sML.create("div", {
              id: "bibi-slider",
              ...
              initialize: function () {
                var t = e.appendChild(
                  sML.create("div", { id: "bibi-slider-edgebar-box" })
                );
                (e.Edgebar = t.appendChild(
                  sML.create("div", { id: "bibi-slider-edgebar" })
                )),
                  (e.Rail = t.appendChild(
                    sML.create("div", { id: "bibi-slider-rail" })
                  )),
                  (e.RailGroove = e.Rail.appendChild(
                    sML.create("div", { id: "bibi-slider-rail-groove" })
                  )),
                  (e.RailProgress = e.RailGroove.appendChild(
                    sML.create("div", { id: "bibi-slider-rail-progress" })
                  )),
                  (e.Thumb = t.appendChild(
                    sML.create("div", {
                  ...
                  F["use-history"] &&
                    (e.classList.add("bibi-slider-with-history"),
                    (e.History = e.appendChild(
                      sML.create("div", { id: "bibi-slider-history" })
                    )),
                    ...
                    (e.History.Button = e.History.appendChild(
                      H.createButtonGroup()
                    ).addButton({
                      ...
                      update: function () {
                        (this.Icon.style.transform = "rotate(".concat(
                          360 * (H.History.List.length - 1),
                          "deg)"
                        )),
                          H.History.List.length <= 1
                            ? H.setUIState(this, "disabled")
                            : "disabled" == this.UIState &&
                              H.setUIState(this, "default");
                      },
                    })),
                  ...
                  F["use-nombre"] &&
                    (W.add(e.Edgebar, ["mouseover", "mousemove"], function (t) {
                      e.Touching ||
                        H.Nombre.progress({
                          List: [
                            {
                              Page: e.getPointedPage(
                                U.getBibiEventCoord(t)[z.A_AXIS_L]
                              ),
                            },
                          ],
                        });
              ...
              resetUISize: function () {
                ...
                (e.RailGroove.style[z.A_SIZE_b] = e.Thumb.style[z.A_SIZE_b] =
                  ""),
                  (e.RailGroove.style[z.A_SIZE_l] =
                    100 - ("center" == e.RailProgressMode ? t : 0) + "%"),
                  (e.Thumb.style[z.A_SIZE_l] = t + "%"),
                  setTimeout(function () {
                    return e.Thumb.classList.toggle(
                      "min",
                      (t = getComputedStyle(e.Thumb, "::after")).width ==
                        t.height
                    );
                    var t;
                  }, 0),
                  ...
                  (e.RailGroove.Before = U.getElementCoord(e.RailGroove)[
                    z.A_AXIS_L
                  ]),
                  (e.RailGroove.Length = e.RailGroove["offset" + z.A_SIZE_L]),
                  (e.RailGroove.After =
                    e.RailGroove.Before + e.RailGroove.Length),
              ...
              onTouchStart: function (t) {
                H.ScrollObserver.forceStopScrolling(),
                  ...
                  (e.StartedAt.Coord =
                    t.target == e.Thumb
                      ? U.getBibiEventCoord(t)[z.A_AXIS_L]
                      : e.StartedAt.ThumbBefore + e.Thumb.Length / 2),
              ...
              onTouchMove: function (t) {
                ...
                if (e.Touching) {
                  var i = sML.limitMinMax(
                    n - e.StartedAt.Coord,
                    e.Edgebar.Before - e.StartedAt.ThumbBefore,
                    e.Edgebar.After - (e.StartedAt.ThumbBefore + e.Thumb.Length)
                  );
                  sML.style(e.Thumb, {
                    ...
                    sML.style(
                      ...
                      d(
                        {},
                        z.A_SIZE_l,
                        e.StartedAt.RailProgressLength +
                          i * ("rtl" == F.ARD ? -1 : 1) +
                          "px"
                      )
                    );
              ...
              flipPagesDuringSliding: function (t) {
                return (e.flipPagesDuringSliding = F[
                  "flip-pages-during-sliding"
                ]
                  ? function (t) {
                      (_.DoNotTurn = !0),
                ...
                return new Promise(function (n) {
                  switch (F.RVM) {
                    case "paged":
                      ...
                      return H.PageObserver.Current.Pages.includes(i)
                        ? n()
                        : _.focusOn({ Destination: i, Duration: 0 }).then(
                            function () {
                              return n();
                            }
                          );
                    default:
                      return (
                        (_.Main["scroll" + z.L_OOBL_L] =
                          e.StartedAt.MainScrollBefore +
                          (t - e.StartedAt.Coord) *
                            (e.MainLength / e.Edgebar.Length)),
                        n()
                      );
                  }
                }).then(function () {
              ...
              progress: function () {
                if (!e.Touching) {
                  ...
                  switch (
                    (F.ARA != F.SLA &&
                      "rtl" == F.ARD &&
                      (t = e.MainLength - t - _.Main.offsetHeight),
                    F.ARA)
                  ) {
                    case "horizontal":
                      (e.Thumb.style.top = ""),
                  ...
                  (e.Thumb.style[z.A_OOBL_l] = (t / e.MainLength) * 100 + "%"),
                    (e.RailProgress.style[z.A_SIZE_l] =
                      (e.getRailProgressLength(
                        U.getElementCoord(e.Thumb)[z.A_AXIS_L] -
                          e.RailGroove.Before
                      ) /
                        e.RailGroove.Length) *
                        100 +
              ...
              getRailProgressLength: function (t) {
                return (e.getRailProgressLength =
                  "center" == e.RailProgressMode
                    ? function (t) {
                        return "rtl" != F.ARD
                          ? t + e.Thumb.Length / 2
                          : e.RailGroove.Length - (t + e.Thumb.Length / 2);
                      }
                    : function (t) {
                        return "rtl" != F.ARD
                          ? t + e.Thumb.Length
                          : e.RailGroove.Length - t;
                      })(t);
              },
              getPointedPage: function (t) {
                var n =
                    (t - e.Edgebar.Before) / e.Edgebar["offset" + z.A_SIZE_L],
                  i = sML.limitMinMax(
                    Math.round(_.Pages.length * ("rtl" == F.ARD ? 1 - n : n)),
                    0,
                    _.Pages.length - 1
                  ),
                  r =
                    _.Main["scroll" + z.L_SIZE_L] *
                    ("rtl" == F.ARD && "ttb" == F.SLD ? 1 - n : n),
                  o = _.Pages[i],
              ...
              getPageDistanceFromPoint: function (e, t) {
                return Math.abs(
                  t -
                    (U.getElementCoord(e, _.Main)[z.L_AXIS_L] +
                      0.5 * e["offset" + z.L_SIZE_L])
                );
              },
            })
          ));
          e.initialize(),
            ...
            W.add("bibi:opened", function () {
              e.Edgebar.addEventListener(W.pointerdown, e.onTouchStart),
                ...
                e.History &&
                  e.History.Button.addEventListener(W.pointerup, e.onTouchEnd),
                W.add(["bibi:is-scrolling", "bibi:scrolled"], e.progress),
                e.progress();
            }),
            W.add(
              ["bibi:opened-slider", "bibi:closed-slider", "bibi:laid-out"],
              function () {
          ...
          if (F["use-bookmarks"] && U.Biscuits) {
            var e = (H.BookmarkManager = {
              ...
              add: function (t) {
                ...
                (t.IsHot = !0), e.Bookmarks.push(t), e.update({ Added: t });
              },
              remove: function (t) {
              ...
              update: function () {
                ...
                (e.Subpanel.Opener.ButtonGroup.style.display = ""),
                  e.ButtonGroup.Buttons &&
                    ((e.ButtonGroup.Buttons = []),
                    (e.ButtonGroup.innerHTML = ""));
                var n = [],
                  i = [];
                if (
                  (Array.isArray(t.Bookmarks) && (e.Bookmarks = t.Bookmarks),
                  t.Added
                    ? (n = [t.Added])
                    : k.Opened &&
                      (H.PageObserver.updateCurrent(),
                      (n = H.PageObserver.Current.Pages.map(function (e) {
                        return {
                          IIPP: H.PageObserver.getIIPP({ Page: e }),
                          "%": Math.floor(
                            ((e.Index + 1) / _.Pages.length) * 100
                          ),
                        };
                      }))),
                  e.Bookmarks.length)
                  ...
                  for (
                    var r = [],
                      o = function (t, o) {
                        var a = e.Bookmarks[o];
                        if ("number" == typeof a) a = { IIPP: a };
                        else {
                          if (!a) return "continue";
                          "number" != typeof a.IIPP &&
                            (a.ItemIndex
                              ? (a.IIPP =
                                  a.ItemIndex +
                                  (a.PageProgressInItem
                                    ? a.PageProgressInItem
                                    : 0))
                              : "pre-paginated" ==
                                  A.Package.Metadata["rendition:layout"] &&
                                ("number" == typeof a.PageNumber &&
                                  (a.PageIndex = a.PageNumber - 1),
                                "number" == typeof a.PageIndex &&
                                  (a.IIPP = a.PageIndex)));
                        }
                        ...
                        var f = e.ButtonGroup.addButton({
                            ...
                            action: function () {
                              return k.Opened
                                ? _.focusOn({ Destination: a }).then(function (
                                    t
                                  ) {
                                    return H.History.add({
                                      UI: e,
                        ...
                        H.setFeedback(g, { StopPropagation: !0 }),
                          ...
                          a.IsHot
                            ? (delete a.IsHot,
                              ...
                              setTimeout(function () {
                                return H.setUIState(
                                  f,
                                  i.includes(a) ? "disabled" : "default"
                                );
                              }, 234))
                            : i.includes(a)
                            ? H.setUIState(f, "disabled")
                            : H.setUIState(f, "default");
                        var h = { IIPP: a.IIPP };
                        a["%"] && (h["%"] = a["%"]), r.push(h);
                      },
                      a = e.Bookmarks.length,
                      s = 0;
                    s < a;
                    s++
                  )
                  ...
                  k.Opened ||
                    (e.Subpanel.Opener.ButtonGroup.style.display = "none");
                e.Bookmarks.length < F["max-bookmarks"] &&
                  ((e.AddButton = e.ButtonGroup.addButton({
                  ...
                  (n.length && !i.length) ||
                    H.setUIState(e.AddButton, "disabled")),
                  U.Biscuits.memorize("Book", { Bookmarks: e.Bookmarks }),
          ...
          var e = (H.Flipper = {
            ...
            isAbleToFlip: function (e) {
              if (
                ...
                if (
                  (e < 0
                    ? ((t = H.PageObserver.Current.List[0]),
                      (n = _.Pages[0]),
                      (i = "Headed"))
                    : ((t = H.PageObserver.Current.List.slice(-1)[0]),
                      (n = _.Pages.slice(-1)[0]),
                      (i = "Footed")),
                  t.Page != n)
                )
                  return !0;
                if (
                  !t.PageIntersectionStatus.Contained &&
                  !t.PageIntersectionStatus[i]
                )
                  return !0;
              }
              return !1;
            ...
            flip: function (t) {
              ...
              H.ScrollObserver.forceStopScrolling();
              var i =
                H.History.List.slice(-1)[0].UI == e &&
                (t < 0 ? -1 : 1) == (e.PreviousDistance < 0 ? -1 : 1);
              if (
                ((e.PreviousDistance = t),
                "pre-paginated" == F["book-rendition-layout"])
              ) {
                var r = [
                    H.PageObserver.Current.List[0].Page.Index,
                    H.PageObserver.Current.List.slice(-1)[0].Page.Index,
                  ],
                  o = r[t < 0 ? 0 : 1] + t;
              ...
              return _.moveBy({ Distance: t, Duration: n.Duration }).then(
                function (t) {
                  return H.History.add({ UI: e, SumUp: i, Destination: t });
                }
              );
            },
          });
          ...
          var e,
            t = (H.Arrows = {
              navigate: function () {
                return setTimeout(function () {
                  [t.Back, t.Forward].forEach(function (e) {
                    return (
                      !!H.Flipper.isAbleToFlip(e.Distance) &&
              ...
              areAvailable: function (e) {
                ...
                if ("horizontal" == F.ARA) {
                  if (
                    e.Coord.X >= window.innerWidth - 3 ||
                    e.Coord.Y >= window.innerHeight - U.Scrollbars.Height - 3
                  )
                    return !1;
                } else if (
                  "vertical" == F.ARA &&
                  (e.Coord.Y >= window.innerHeight - 3 ||
                    e.Coord.X >= window.innerWidth - U.Scrollbars.Width - 3)
                )
                  return !1;
                return e.Target.ownerDocument.documentElement != U.HTML
                  ? !U.isPointableContent(e.Target)
                  : e.Target == U.HTML ||
                      e.Target == U.Body ||
                      e.Target == H.Menu ||
                      !!/^(bibi-main|bibi-arrow|bibi-help|bibi-poweredby)/.test(
                        e.Target.id
                      ) ||
                      !!/^(spread|item|page)( |-|$)/.test(e.Target.className);
              },
            });
          U.HTML.classList.add("arrows-active"),
            ...
            [t.Back, t.Forward].forEach(function (e) {
              ...
              var t = [
                e.showHelp,
                e.hideHelp,
                e.BibiTapObserver.onTap,
                e.BibiTapObserver.onDoubleTap,
              ];
              U.TouchOS ||
                t.push(
                  e.BibiHoverObserver.onHover,
                  e.BibiHoverObserver.onUnHover
                ),
                t.forEach(function (e) {
                  return function () {};
                });
            ...
            W.add("bibi:commands:move-by", function (e) {
              return (
                !!(
                  ...
                  isFinite(e) &&
                  (e = Math.round(e))
                ) && W.dispatch(e < 0 ? t.Back : t.Forward, "bibi:tapped", null)
              );
            }),
            W.add("bibi:loaded-item", function (e) {
              sML.appendCSSRule(
                e.contentDocument,
                "html[data-bibi-cursor]",
                "cursor: pointer;"
              );
            }),
            W.add("bibi:opened", function () {
            ...
            (e = function (e, t, n) {
              return sML.appendCSSRule(
                ""
                  .concat(e, " div#bibi-arrow-back, ")
                  .concat(e, " div#bibi-arrow-forward"),
                ""
                  .concat(t, ": calc(100% - ")
                  .concat(n, "px); ")
                  .concat(t, ": calc(100v")
            ...
            e(
              ...
              "height",
              U.Scrollbars.Width + H.Menu.Height
            ),
            e(
          ...
          H.AxisSwitcher = {
            switchAxis: function () {
              return new Promise(function (e) {
                ...
                H.Menu.Config.ViewModeSection.ButtonGroups[0].Buttons.filter(
                  function (e) {
                    return e.Mode == t;
                  }
      ...
      (H.Spinner = {
        create: function () {
          for (
            var e = (H.Spinner = U.Body.appendChild(
                sML.create("div", { id: "bibi-spinner" })
              )),
              t = 1;
            t <= 12;
            t++
      ...
      (H.createButtonGroup = function () {
        ...
        return (
          ...
          (r.addButton = function (e) {
            ...
            return t
              ? ((t.ButtonGroup = this),
                (t.ButtonBox = t.ButtonGroup.appendChild(
                  sML.create("li", {
                    className: "bibi-buttonbox bibi-buttonbox-" + t.Type,
                  })
                )),
                U.TouchOS ||
                  (H.TouchObserver.observeElementHover(t.ButtonBox),
      ...
      (H.createButton = function () {
        ...
        ("string" == typeof e.className && e.className) || delete e.className,
          ...
          (e.Type =
            ...
            /^(normal|toggle|radio|link)$/.test(e.Type)
              ? e.Type
              : "normal");
        ...
        e.className && t.push(e.className),
          ...
          void 0 === e.Icon ||
            e.Icon.tagName ||
            ("string" == typeof e.Icon && e.Icon
              ? (e.Icon = sML.hatch(e.Icon))
              : delete e.Icon);
        var n = sML.create("string" == typeof e.href ? "a" : "span", e);
        return (
          n.Icon &&
            ((n.IconBox = n.appendChild(
              sML.create("span", { className: "bibi-button-iconbox" })
            )),
            n.IconBox.appendChild(n.Icon),
            (n.Icon = n.IconBox.firstChild),
            (n.IconBox.Button = n.Icon.Button = n)),
          (n.Label = n.appendChild(
            sML.create("span", { className: "bibi-button-label" })
          )),
          H.setFeedback(n, {
            Help: e.Help,
            Checked: e.Checked,
          ...
          (n.isAvailable = function () {
            return (
              !n.Busy &&
              (!n.ButtonGroup || !n.ButtonGroup.Busy) &&
              "disabled" != n.UIState
            );
          }),
          "function" == typeof n.action &&
            W.add(n, "bibi:tapped", function () {
      ...
      (H.createSubpanel = function () {
        ...
        var t = [
          "bibi-subpanel",
          "bibi-subpanel-" + ("left" == e.Position ? "left" : "right"),
        ];
        e.className && t.push(e.className), (e.className = t.join(" "));
        var n = Array.isArray(e.Sections)
          ? e.Sections
          : e.Section
          ? [e.Section]
          : [];
          ...
          H.setToggleAction(i, {
            ...
            onclosed: function (t) {
              this.classList.remove("opened"),
                ...
                (t && t.ForAnotherSubpanel) ||
                  U.HTML.classList.remove("subpanel-opened"),
      ...
      (H.createSubpanelSection = function () {
        ...
        var n = Array.isArray(e.ButtonGroups)
          ? e.ButtonGroups
          : e.ButtonGroup
          ? [e.ButtonGroup]
          : [];
        ...
        return (
          i.Labels &&
            ((i.Labels = H.distillLabels(i.Labels)),
            i
      ...
      (H.setFeedback = function (e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (
          (e.Labels = H.distillLabels(e.Labels)),
          e.Labels &&
            (t.Help &&
              ((e.showHelp = function () {
                return (
                  H.Help &&
                    e.Labels[e.UIState] &&
                    H.Help.show(e.Labels[e.UIState][U.Language]),
                  e
                );
              }),
              (e.hideHelp = function () {
          ...
          U.TouchOS ||
            (H.TouchObserver.observeElementHover(e),
            H.TouchObserver.setElementHoverActions(e)),
        ...
        if (
          ...
          return (
            ...
            e.tagName &&
              (e.Labels &&
                e.Labels[e.UIState] &&
                e.Labels[e.UIState][U.Language] &&
                ((e.title = e.Labels[e.UIState][U.Language].replace(
                  /<[^>]+>/g,
                  ""
                )),
                e.Label &&
                  (e.Label.innerHTML = e.Labels[e.UIState][U.Language])),
      ...
      (H.isPointerStealth = function () {
        var e = !1;
        return (
          H.isPointerStealth.Checkers.forEach(function (t) {
            return (e = !!t() || e);
          }),
          e
        );
      ...
      (H.isPointerStealth.addChecker = function (e) {
        return "function" != typeof e || H.isPointerStealth.Checkers.includes(e)
          ? H.isPointerStealth.Checkers.length
          : H.isPointerStealth.Checkers.push(e);
      }),
      (H.distillLabels = function (e) {
        for (var t in (("object" == I(e) && e) || (e = {}), e))
          e[t] = H.distillLabels.distillLanguage(e[t]);
        return (
          e.default || (e.default = H.distillLabels.distillLanguage()),
      ...
      (H.distillLabels.distillLanguage = function (e) {
        return (
          ("object" == I(e) && e) || (e = { default: e }),
          "string" != typeof e.default &&
            ("string" == typeof e.en
              ? (e.default = e.en)
              : "string" == typeof e[U.Language]
              ? (e.default = e[U.Language])
              : (e.default = "")),
          "string" != typeof e[U.Language] &&
            ("string" == typeof e.default
              ? (e[U.Language] = e.default)
              : "string" == typeof e.en
              ? (e[U.Language] = e.en)
              : (e[U.Language] = "")),
          e
    ...
    (x.preset = function (e) {
      return x.at1st.List.push(function () {
        x.applyFilteredSettingsTo(
          D,
          e,
          [x.SettingTypes, x.SettingTypes_PresetOnly],
          "Fill"
        ),
          delete D.book,
      ...
      (D.initialize = function () {
        ...
        (D.bookshelf = new URL(
          D.bookshelf || "../../bibi-bookshelf",
          D.Script.src
        ).href.replace(/\/$/, "")),
          (D.extensions =
            ((e = document
              .getElementById("bibi-preset")
              .getAttribute("data-bibi-extensions")) &&
              (e = e
                .trim()
                .replace(/\s+/, " ")
                .split(" ")
                .map(function (e) {
                  return { src: new URL(e, t).href };
                })).length &&
              (D.extensions = e),
            Array.isArray(D.extensions)
              ? D.extensions.filter(function (e) {
                  ...
                  return (
                    !(!e || !e.src || "string" != typeof e.src) &&
                    (e.src = new URL(e.src, D.Script.src).href)
                  );
                })
              : [])),
          delete D.initialize;
    ...
    x.at1st.List.unshift(function () {
      ...
      if ("string" == typeof e) {
        ...
        Object.assign(
          R,
          x.applyFilteredSettingsTo(t, t, [
            x.SettingTypes,
            x.SettingTypes_UserOnly,
          ])
        ),
          R.book || delete R.zine,
          R.debug && ((x.Debug = !0), (R.log = 9));
      }
    }),
      (R.initialize = function () {
        var e = x.applyFilteredSettingsTo({}, R, [
            x.SettingTypes,
            x.SettingTypes_UserOnly,
          ]),
          t = (function () {
            ...
            t))
              if ("EPUBCFI" != i) {
                ...
                r &&
                  ((t[i] = x.applyFilteredSettingsTo({}, r, [
                    x.SettingTypes,
                    x.SettingTypes_UserOnly,
                  ])),
                  delete t[i].book);
        ...
        t.Jo &&
          (Object.assign(e, (e.Jo = t.Jo)),
          history.replaceState &&
            history.replaceState(
              null,
              null,
              location.href.replace(/[&#]jo\([^\)]*\)$/g, "")
            )),
        ...
        Object.assign(R, e),
          "number" == typeof R.nav
            ...
            : "string" == typeof R.p
            ? (_.StartOn = { P: R.p })
            : "number" == typeof R.iipp
            ? (_.StartOn = { IIPP: R.iipp })
            : "string" == typeof R.edge
            ? (_.StartOn = { Edge: R.edge })
            : "string" == typeof R.EPUBCFI &&
              W.add("bibi:readied", function () {
    ...
    var N = {
        initialize: function () {
          var e = document
            .getElementById("bibi-preset")
            .getAttribute("data-bibi-bookshelf");
          e && (N.bookshelf = new URL(e, location.href.split("?")[0])),
            document.body.getAttribute("data-bibi-book") &&
              (N.book = document.body.getAttribute("data-bibi-book"));
          var t = document.getElementById("bibi-book-data");
          if (t) {
            var n = t.innerText.trim();
            if (n) {
              var i = t.getAttribute("data-bibi-book-mimetype");
              /^application\/(epub\+zip|zip|x-zip(-compressed)?)$/i.test(i) &&
                ((N["book-data"] = n), (N["book-data-mimetype"] = i));
            }
      ...
      F = {
        initialize: function () {
          ...
          if (
            (sML.applyRtL(F, D, "ExceptFunctions"),
            sML.applyRtL(F, R, "ExceptFunctions"),
            sML.applyRtL(F, N, "ExceptFunctions"),
            x.SettingTypes["yes-no"]
              .concat(x.SettingTypes_PresetOnly["yes-no"])
              .concat(x.SettingTypes_UserOnly["yes-no"])
              .forEach(function (e) {
                return (F[e] =
                  "yes" == F[e] ||
                  ("mobile" == F[e] && U.TouchOS) ||
                  ("desktop" == F[e] && !U.TouchOS));
              }),
            F["trustworthy-origins"].includes(U.Origin) ||
              F["trustworthy-origins"].unshift(U.Origin),
            (F.book =
              !F["book-data"] && "string" == typeof F.book && F.book
                ? new URL(F.book, F.bookshelf + "/").href
                : ""),
            !F["book-data"] &&
              F.book &&
              !F["trustworthy-origins"].includes(new URL(F.book).origin))
          )
            throw "The Origin of the Path of the Book Is Not Allowed.";
          "number" != typeof F["parent-bibi-index"] &&
            delete F["parent-bibi-index"],
            F.book || !window.File
              ? ((F["accept-local-file"] = !1),
                (F["accept-blob-converted-data"] = !1),
                (F["accept-base64-encoded-data"] = !1))
              : (F["accept-local-file"] = !(
                  !F["accept-local-file"] ||
                  !(
                    F["extract-if-necessary"].includes("*") ||
            ...
            (F.autostart =
              ...
              (!F.book ||
                (window.parent != window
                  ? F["autostart-embedded"]
                  : F.autostart))),
            (F["start-in-new-window"] =
              window.parent != window &&
              !F.autostart &&
              F["start-embedded-in-new-window"]),
            (F["default-page-progression-direction"] =
              "rtl" == F["default-page-progression-direction"] ? "rtl" : "ltr"),
            ...
            U.Biscuits &&
              W.bind("bibi:initialized-book", function () {
                ...
                F["keep-settings"] &&
                  (!R["reader-view-mode"] &&
                    e.RVM &&
                    (F["reader-view-mode"] = e.RVM),
                  !R["full-breadth-layout-in-scroll"] &&
                    e.FBL &&
                  ...
                  F["resume-from-last-position"] &&
                    ...
                    e.Position &&
                    e.Position.IIPP &&
                    (_.StartOn = sML.clone(e.Position));
              }),
            (F.Modes = {
        ...
        update: function (e) {
          ...
          for (var r in ((F["book-rendition-layout"] =
            A.Package.Metadata["rendition:layout"]),
          (F["allow-placeholders"] =
            F["allow-placeholders"] && A.AllowPlaceholderItems),
          F.FontFamilyStyleIndex && sML.deleteCSSRule(F.FontFamilyStyleIndex),
          F["ui-font-family"] &&
            (F.FontFamilyStyleIndex = sML.appendCSSRule(
              "html",
              "font-family: " + F["ui-font-family"] + " !important;"
            )),
          (F["page-progression-direction"] = A.PPD),
          "x" == F["pagination-method"]
            ? (F["spread-layout-axis"] =
                "vertical" == F["reader-view-mode"] ? "vertical" : "horizontal")
            : (F["spread-layout-axis"] = (function () {
          ...
          (F["apparent-reading-axis"] =
            "paged" == F["reader-view-mode"]
              ? "horizontal"
              : F["reader-view-mode"]),
          (F["apparent-reading-direction"] =
            "vertical" == F["reader-view-mode"]
              ? "ttb"
              : F["page-progression-direction"]),
          (F["spread-layout-direction"] =
            "vertical" == F["spread-layout-axis"]
              ? "ttb"
              : F["page-progression-direction"]),
          (F["navigation-layout-direction"] =
            F["fix-nav-ttb"] || "rtl" != F["page-progression-direction"]
              ? "ttb"
              : "rtl"),
          F.Modes)) {
            var o = F.Modes[r].CNP + "-",
      ...
      z = {
        ...
        probe: function (e, t) {
          ...
          "ltr" != F.PPD && n.reverse(),
            "horizontal" == t
              ? (z._app(e, "BASE", { b: n[0], a: n[1], s: "top", e: "bottom" }),
                z._app(e, "SIZE", { b: "height", l: "width" }),
                z._app(e, "OOBL", { b: "top", l: "left" }),
                z._app(e, "OEBL", { b: "bottom", l: "right" }),
                z._app(e, "AXIS", { b: "y", l: "x" }),
                (z[e + "_AXIS_D"] = "ltr" == F.PPD ? 1 : -1))
              : (z._app(e, "BASE", { b: "top", a: "bottom", s: n[0], e: n[1] }),
                z._app(e, "SIZE", { b: "width", l: "height" }),
                z._app(e, "OOBL", { b: "left", l: "top" }),
                z._app(e, "OEBL", { b: "right", l: "bottom" }),
                z._app(e, "AXIS", { b: "x", l: "y" }),
                (z[e + "_AXIS_D"] = 1));
        },
        _app: function (e, t, n) {
          for (var i in n)
              ...
              switch (r) {
                case "<b:>":
                  a.unshift("📕"),
                    ...
                    s.push(U.log.BStyle),
                    a.push(
                      "%c(v".concat(x.version, ")") + (x.Dev ? ":%cDEV" : "")
                    ),
                    s.push(U.log.NStyle),
    ...
    (U.log.initialize = function () {
      ...
      (U.log.Limit =
        R.hasOwnProperty("log") && "number" == typeof (R.log *= 1) ? R.log : 0),
        (U.log.Depth = 1),
        (U.log.NStyle =
          "font: normal normal 10px/1 Menlo, Consolas, monospace;"),
        (U.log.BStyle =
          "font: normal bold   10px/1 Menlo, Consolas, monospace;"),
        (U.log.distill =
          sML.UA.Trident || sML.UA.EdgeHTML
            ? function (e, t) {
      ...
      (U.getTimeLabel = function () {
        var e =
          arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
            : Date.now() - x.TimeOrigin;
        return (
          [e / 1e3 / 60 / 60, (e / 1e3 / 60) % 60, (e / 1e3) % 60]
            .map(function (e) {
              return String(Math.floor(e)).padStart(2, 0);
            })
            .join(":") +
          "." +
          String(e % 1e3).padStart(3, 0)
        );
      }),
      (U.stamp = function (e) {
        var t =
      ...
      (U.isToBeExtractedIfNecessary = function (e) {
        ...
        for (var t = F["extract-if-necessary"].length, n = 0; n < t; n++)
          if (
            new RegExp(
              F["extract-if-necessary"][n].replace(/\./g, "\\.") + "$",
              "i"
            ).test(e)
          )
            return !0;
      ...
      (U.src = function (e) {
        return (
          A.Package.Manifest[e.Path] || (A.Package.Manifest[e.Path] = e),
        ...
        return (
          e.Resources &&
            e.Resources.forEach(function (e) {
              return e.Retlieved
                ? Promise.resolve()
                : U.RangeLoader.abort(e.Path);
            }),
          e.Retlieved ? Promise.resolve() : U.RangeLoader.abort(e.Path)
        );
      }),
      (U.extract = function (e) {
        return (e = U.src(e)).Retlieving
          ? e.Retlieving
          : e.Content
          ? Promise.resolve(e)
          : e.URI
          ? U.download(e)
          : (e.Retlieving = U.RangeLoader.getBuffer(e.Path)
              .then(function (t) {
                return (
                  U.isBin(e)
                    ? ((e.DataType = "Blob"),
                      (e.Content = new Blob([t], { type: e["media-type"] })))
                    : ((e.DataType = "Text"),
                      (e.Content = new TextDecoder("utf-8").decode(
                        new Uint8Array(t)
                      ))),
                  (e.Retlieved = !0),
                  delete e.Retlieving,
                ...
                return (
                  ...
                  Promise.reject(
                    /404/.test(t)
                      ? x.ErrorMessages.NotFound
                      : /aborted/.test(t)
                      ? x.ErrorMessages.Canceled
                      : /fetch/.test(t)
                      ? x.ErrorMessages.CORSBlocked
                      : /not found/.test(t) || /invalid/.test(t)
                      ? x.ErrorMessages.DataInvalid
                      : t
                  )
                );
              }));
        ...
        return new Promise(function (n, i) {
          ...
          (function () {
            ...
            switch (A.ExtractionPolicy) {
              ...
              case "at-once":
                return Promise.reject(
                  'File Not Included: "'.concat(e.Path, '"')
                );
            }
          })()
            .then(function (e) {
              return (
                "function" == typeof t.initialize && t.initialize(e),
      ...
      (U.isBin = function (e) {
        return /\.(aac|gif|jpe?g|m4[av]|mp[g34]|ogg|[ot]tf|pdf|png|web[mp]|woff2?)$/i.test(
          e.Path
        );
      }),
      (U.createBlobURL = function (e, t, n) {
        return URL.createObjectURL(
          "Text" == e ? new Blob([t], { type: n }) : t
        );
      }),
      (U.ContentTypes = {
        pdf: "application/pdf",
      ...
      (U.preprocess = function (e) {
        ...
        if (
          (n.ReplaceRules &&
            (e.Content = n.ReplaceRules.reduce(function (e, t) {
            ...
            return n.Patterns.forEach(function (o) {
              ...
              if (s) {
                ...
                s.forEach(function (o) {
                  ...
                  if (c.test(l[0])) {
                    var u = U.src({ Path: l[0] });
                    t.push(u),
                      i.push(
                        U.file(u, { Preprocess: !0, URI: !0 }).then(function (
                          t
                        ) {
                          (l[0] = t.URI),
        ...
        css: {
          ...
          ResolveRules: [
            ...
            },
            {
              ...
              PathRef: "$1",
              Patterns: [{ Extensions: "gif|png|jpe?g|svg|ttf|otf|woff" }],
            },
          ],
          init: function () {
            ...
            return (
              e.push([
                /(-(epub|webkit)-)?column-count\s*:\s*1\s*([;\}])/gm,
                "column-count: auto$3",
              ]),
              e.push([
                /(-(epub|webkit)-)?text-underline-position\s*:/gm,
                "text-underline-position:",
              ]),
              sML.UA.Chromium || sML.UA.WebKit
                ? this
                : (e.push([/-(epub|webkit)-/gm, ""]),
                  sML.UA.Gecko
                    ? (e.push([
                        /text-combine-horizontal\s*:\s*([^;\}]+)\s*([;\}])/gm,
                        "text-combine-upright: $1$2",
                      ]),
                      e.push([
                        /text-combine\s*:\s*horizontal\s*([;\}])/gm,
                        "text-combine-upright: all$1",
                      ]),
                      this)
                    : (sML.UA.EdgeHTML &&
                        (e.push([
                          /text-combine-(upright|horizontal)\s*:\s*([^;\}\s]+)\s*([;\}])/gm,
                          "text-combine-horizontal: $2; text-combine-upright: $2$3",
                        ]),
                        e.push([
                          /text-combine\s*:\s*horizontal\s*([;\}])/gm,
                          "text-combine-horizontal: all; text-combine-upright: all$1",
                        ])),
                      sML.UA.Trident &&
                        (e.push([
                          /writing-mode\s*:\s*vertical-rl\s*([;\}])/gm,
                          "writing-mode: tb-rl$1",
                        ]),
                        e.push([
                          /writing-mode\s*:\s*vertical-lr\s*([;\}])/gm,
                          "writing-mode: tb-lr$1",
                        ]),
                        e.push([
                          /writing-mode\s*:\s*horizontal-tb\s*([;\}])/gm,
                          "writing-mode: lr-tb$1",
                        ]),
                        e.push([
                          /text-combine-(upright|horizontal)\s*:\s*([^;\}\s]+)\s*([;\}])/gm,
                          "-ms-text-combine-horizontal: $2$3",
                        ]),
                        e.push([
                          /text-combine\s*:\s*horizontal\s*([;\}])/gm,
                          "-ms-text-combine-horizontal: all$1",
                        ])),
                      /^(zho?|chi|kor?|ja|jpn)$/.test(A.Language) &&
                        e.push([
                          /text-align\s*:\s*justify\s*([;\}])/gm,
                          "text-align: justify; text-justify: inter-ideograph$1",
                        ]),
                      this))
            );
          },
      ...
      (U.openDocument = function (e) {
        return U.file(e).then(function (e) {
          return new DOMParser().parseFromString(
            e.Content,
            /\.(xml|opf|ncx)$/i.test(e.Path) ? "text/xml" : "text/html"
          );
        });
      }),
      (U.editCSSRules = function () {
        ...
        "function" == typeof arguments[0]
          ...
          e.styleSheets &&
            "function" == typeof t &&
            sML.forEach(e.styleSheets)(function (e) {
      ...
      (U.editCSSRulesOfStyleSheet = function (e, t) {
        ...
        for (var n = e.cssRules.length, i = 0; i < n; i++) {
          var r = e.cssRules[i];
          r.cssRules
            ? U.editCSSRulesOfStyleSheet(r, t)
            : r.styleSheet
            ? U.editCSSRulesOfStyleSheet(r.styleSheet, t)
            : t(r);
        }
      }),
      (U.getWritingMode = function (e) {
        var t = getComputedStyle(e);
        return U.WritingModeProperty
          ? /^vertical-/.test(t[U.WritingModeProperty])
            ? ("rtl" == t.direction ? "bt" : "tb") +
              "-" +
              (/-lr$/.test(t[U.WritingModeProperty]) ? "lr" : "rl")
            : /^horizontal-/.test(t[U.WritingModeProperty])
            ? ("rtl" == t.direction ? "rl" : "lr") +
              "-" +
              (/-bt$/.test(t[U.WritingModeProperty]) ? "bt" : "tb")
            : /^(lr|rl|tb|bt)-/.test(t[U.WritingModeProperty])
            ? t[U.WritingModeProperty]
            : void 0
          : "rtl" == t.direction
          ? "rl-tb"
          : "lr-tb";
      ...
      (U.getElementInnerText = function (e) {
        ...
        return (
          ...
          void 0 !== n.textContent
            ? (t = n.textContent)
            : void 0 !== n.innerText && (t = n.innerText),
          t.replace(/[\r\n\s\t ]/g, "")
        );
      }),
      (U.getElementCoord = function (e, t) {
        ...
        for (t = t && t.tagName ? t : null; e.offsetParent != t; )
          (e = e.offsetParent), (n.X += e.offsetLeft), (n.Y += e.offsetTop);
        return n;
      }),
      ...
      (U.getPath = function () {
        ...
        if (2 == arguments.length && /^[\w\d]+:\/\//.test(arguments[1]))
          ...
          for (var n = arguments.length, i = 1; i < n; i++)
            t += "/" + arguments[i];
        for (
          t.replace(/^([a-zA-Z]+:\/\/[^\/]+)?\/*(.*)$/, function (n, i, r) {
            (e = i), (t = r);
          });
          /([^:\/])\/{2,}/.test(t);
      ...
      (U.getViewportByMetaContent = function (e) {
        if ("string" == typeof e && /width/.test(e) && /height/.test(e)) {
          var t =
              1 *
              (e = e.replace(/\s+/g, "")).replace(/^.*?width=(\d+).*$/, "$1"),
      ...
      (U.getBibiEvent = function (e) {
        ...
        var t,
          ...
          i,
          r,
          o = U.getBibiEventCoord(e),
          a = F["flipper-width"],
          s = { X: o.X / window.innerWidth, Y: o.Y / window.innerHeight };
        a < 1
          ? ((r = t = a), (n = i = 1 - a))
          : ((n = 1 - (r = a / window.innerWidth)),
            (i = 1 - (t = a / window.innerHeight)));
        var c = {};
        return (
          (c.X = s.X < r ? "left" : n < s.X ? "right" : "center"),
          (c.Y = s.Y < t ? "top" : i < s.Y ? "bottom" : "middle"),
          { Target: e.target, Coord: o, Ratio: s, Division: c }
        );
      }),
      ...
      (U.getCoordInViewport = function (e, t) {
        if (t == document)
          (e.X -= U.Body.scrollLeft), (e.Y -= U.Body.scrollTop);
        else {
          var n = _.Main,
          ...
          "pre-paginated" == l["rendition:layout"] ||
            l.Outsourcing ||
            ((d.X += F["item-padding-left"]), (d.Y += F["item-padding-top"])),
            (e.X = Math.floor(
              n.offsetLeft + (o + s + (d.X + e.X * u - n.scrollLeft - o) * r)
            )),
            (e.Y = Math.floor(
              n.offsetTop + (a + c + (d.Y + e.Y * u - n.scrollTop - a) * r)
            ));
        }
        return e;
      }),
      (U.Cookies = {
        ...
        remember: function (e) {
          ...
          return (
            console.log("Cookies:", t), "string" == typeof e && e ? t[e] : t
          );
        },
        eat: function (e, t, n) {
      ...
      (U.Biscuits = {
        ...
        initialize: function (e) {
          ...
          if ("string" != typeof e)
            return (
              (U.Biscuits.LabelBase =
                "BibiBiscuits:" +
                D.Script.src.replace(
                  new RegExp("^" + U.Origin.replace(/([\/\.])/g, "\\$1")),
                  ""
                )),
          ...
          var t = (U.Biscuits.Labels[e] =
              U.Biscuits.LabelBase + ("Book" == e ? "#" + A.ID : "")),
            n = localStorage.getItem(t);
          return (
            (U.Biscuits.Memories[t] = n ? JSON.parse(n) : {}),
        ...
        remember: function (e, t) {
          ...
          return t && "string" == typeof t
            ? U.Biscuits.Memories[n][t]
            : U.Biscuits.Memories[n];
        },
        memorize: function (e, t) {
            ...
            for (var i in t) {
              ...
              try {
                if (
                  !r ||
                  "function" == typeof r ||
                  void 0 === JSON.parse(JSON.stringify(d({}, i, r)))[i]
                )
                  throw "";
          ...
          return localStorage.setItem(
            n,
            JSON.stringify(U.Biscuits.Memories[n])
          );
        },
        forget: function (e, t) {
          if (e)
            if ("string" == typeof e && U.Biscuits.Labels[e]) {
              ...
              t
                ? ("string" == typeof t && (t = [t]),
                  Array.isArray(t) &&
                    t.forEach(function (e) {
                      return (
                        !("string" != typeof e || !e) &&
                        delete U.Biscuits.Memories[n][e]
                      );
                    }),
                ...
                : (localStorage.removeItem(n), delete U.Biscuits.Memories[n]);
            } else;
          else
    ...
    var W = {
      ...
      j = {
        judge: function (e, t) {
          return (
            ...
            t &&
            "string" == typeof t &&
            F["trustworthy-origins"].includes(t)
          );
        },
        post: function (e) {
          return (
            !!j.judge(e, U.ParentOrigin) &&
            window.parent.postMessage(e, window.parent.location.origin)
          );
        },
        receive: function (e) {
      ...
      X = {
        ...
        load: function (e) {
          return new Promise(function (t, n) {
            if (!e.src || "string" != typeof e.src)
              return n(
                '"path" of the Extension Seems to Be Invalid. ("'.concat(
                  e.src,
                  '")'
                )
              );
            ...
            e.Script = document.head.appendChild(
              sML.create("script", {
        ...
        add: function (e) {
          ...
          if (X[e.id])
            return t.reject(
              '"id" of the extension is reserved or already used by another. ("'.concat(
                e.id,
                '")'
              )
            );
      ...
      document.addEventListener("DOMContentLoaded", function () {
        (Bibi.Script = document.getElementById("bibi-script")),
          (function (e) {
            ...
            if (
              (window.TextDecoder || t.push(n + "/encoding.js"),
              window.IntersectionObserver ||
                t.push(n + "/intersection-observer.js"),
              !t.length)
            )
              return e();
            var i = [];
            ...
            for (var e = "", t = Bibi.Script.nextElementSibling; t; ) {
              if (
                /^style$/i.test(t.tagName) &&
                /^\/\*! Bibi Book Style \*\//.test(t.textContent)
              ) {
            ...
            if (
              ((Bibi.BookStyleURL = O.createBlobURL("Text", e, "text/css")),
              o.a.UA.Trident)
            ) {
              document.documentElement.style.display = "none";
              var n = Array.prototype.map.call(
                document.head.querySelectorAll("#bibi-style, #bibi-dress"),
                function (e) {
