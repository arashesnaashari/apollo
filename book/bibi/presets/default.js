Bibi.preset({
  ...
  "font-size-scale-per-step": 1.5, // Number of scale

  "use-loupe": "no", // "yes" or "no" or "desktop" or "mobile" (Note: Loupe buttons will not appear in touch-devices even if it is set "yes" or "mobile".)
  ...
  "item-padding-left": 50, // Number of pixel (It affects only for reflowable books.)
  "item-padding-right": 50, // Number of pixel (It affects only for reflowable books.)
  "item-padding-top": 48, // Number of pixel (It affects only for reflowable books.)
  "item-padding-bottom": 50, // Number of pixel (It affects only for reflowable books.)

  "spread-gap": 48, // Number of pixel (It affects only in paged view mode.)
  "spread-margin": 0, // Number of pixel

  "fix-nav-ttb": "yes", // "yes" or "no" or "desktop" or "mobile"
  ...
  "default-page-progression-direction": "rtl", // "ltr" or "rtl". Most of EPUBs have right property in itself, but....
  ...
  "pagination-method": "x", // "auto" or "x". (It affects only for vertical-text reflowable books. More info is <04> at the bottom of this preset file.)
